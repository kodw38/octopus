...
public abstract class CtBehavior extends CtMember {
    ...
    protected CtBehavior(com.octopus.utils.cls.javassist.CtClass clazz, MethodInfo minfo) {
        super(clazz);
        methodInfo = minfo;
    }
    ...
    {
        com.octopus.utils.cls.javassist.CtClass declaring = declaringClass;
        MethodInfo srcInfo = src.methodInfo;
        com.octopus.utils.cls.javassist.CtClass srcClass = src.getDeclaringClass();
        ...
        try {
            boolean patch = false;
            com.octopus.utils.cls.javassist.CtClass srcSuper = srcClass.getSuperclass();
            com.octopus.utils.cls.javassist.CtClass destSuper = declaring.getSuperclass();
            ...
            if (srcSuper != null && destSuper != null) {
                ...
                if (!srcSuperName.equals(destSuperName))
                    if (srcSuperName.equals(com.octopus.utils.cls.javassist.CtClass.javaLangObject))
                        patch = true;
                    else
     ...
     * such as <code>com.octopus.utils.cls.javassist.CtBehavior.stBody(String)</code>.
     *
     * @since 3.5
     */
     ...
     *
     * @see com.octopus.utils.cls.javassist.bytecode.MethodInfo#rebuildStackMap(com.octopus.utils.cls.javassist.ClassPool)
     */
     ...
     */
    public com.octopus.utils.cls.javassist.CtClass[] getParameterTypes() throws NotFoundException {
     ...
     */
    com.octopus.utils.cls.javassist.CtClass getReturnType0() throws NotFoundException {
     ...
     */
    public com.octopus.utils.cls.javassist.CtClass[] getExceptionTypes() throws NotFoundException {
        String[] exceptions;
     ...
     */
    public void setExceptionTypes(com.octopus.utils.cls.javassist.CtClass[] types) throws NotFoundException {
        declaringClass.checkModify();
    ...
    static void setBody0(com.octopus.utils.cls.javassist.CtClass srcClass, MethodInfo srcInfo,
                         com.octopus.utils.cls.javassist.CtClass destClass, MethodInfo destInfo,
                         ClassMap map)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
     ...
     * <code>com.octopus.utils.cls.javassist.runtime.Cflow</code> at runtime
     ...
     *
     * @see com.octopus.utils.cls.javassist.runtime.Cflow
     */
    public void useCflow(String name) throws com.octopus.utils.cls.javassist.CannotCompileException {
        com.octopus.utils.cls.javassist.CtClass cc = declaringClass;
        cc.checkModify();
        com.octopus.utils.cls.javassist.ClassPool pool = cc.getClassPool();
        String fname;
        int i = 0;
        while (true) {
            fname = "_cflow$" + i++;
        ...
        try {
            com.octopus.utils.cls.javassist.CtClass type = pool.get("com.octopus.utils.cls.javassist.runtime.Cflow");
            com.octopus.utils.cls.javassist.CtField field = new com.octopus.utils.cls.javassist.CtField(type, fname, cc);
            field.setModifiers(com.octopus.utils.cls.javassist.Modifier.PUBLIC | com.octopus.utils.cls.javassist.Modifier.STATIC);
     ...
     */
    public void addLocalVariable(String name, com.octopus.utils.cls.javassist.CtClass type)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        declaringClass.checkModify();
        ...
        if (ca == null)
            throw new com.octopus.utils.cls.javassist.CannotCompileException("no method body");
     ...
     */
    public void insertParameter(com.octopus.utils.cls.javassist.CtClass type)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        declaringClass.checkModify();
        ...
        try {
            addParameter2(com.octopus.utils.cls.javassist.Modifier.isStatic(getModifiers()) ? 0 : 1, type, desc);
        }
        catch (BadBytecode e) {
            throw new com.octopus.utils.cls.javassist.CannotCompileException(e);
        }
     ...
     */
    public void addParameter(com.octopus.utils.cls.javassist.CtClass type)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        declaringClass.checkModify();
        String desc = methodInfo.getDescriptor();
        String desc2 = Descriptor.appendParameter(type, desc);
        int offset = com.octopus.utils.cls.javassist.Modifier.isStatic(getModifiers()) ? 0 : 1;
        try {
    ...
    private void addParameter2(int where, com.octopus.utils.cls.javassist.CtClass type, String desc)
        throws BadBytecode
    {
        CodeAttribute ca = methodInfo.getCodeAttribute();
        if (ca != null) {
            ...
            int classInfo = 0;
            if (type.isPrimitive()) {
                com.octopus.utils.cls.javassist.CtPrimitiveType cpt = (com.octopus.utils.cls.javassist.CtPrimitiveType)type;
     ...
     * @see com.octopus.utils.cls.javassist.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
     ...
     *                  It must be a single statement or block.
     * @see com.octopus.utils.cls.javassist.CtConstructor#insertBeforeBody(String)
     */
    public void insertBefore(String src) throws com.octopus.utils.cls.javassist.CannotCompileException {
        ...
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        ...
        try {
            int nvars = jv.recordParams(getParameterTypes(),
                                        com.octopus.utils.cls.javassist.Modifier.isStatic(getModifiers()));
        ...
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        ...
        try {
            int nvars = jv.recordParams(getParameterTypes(),
                                        com.octopus.utils.cls.javassist.Modifier.isStatic(getModifiers()));
            jv.recordParamNames(ca, nvars);
            com.octopus.utils.cls.javassist.CtClass rtype = getReturnType0();
    ...
    private int insertAfterAdvice(Bytecode code, Javac jv, String src,
                                  ConstPool cp, com.octopus.utils.cls.javassist.CtClass rtype, int varNo)
        throws CompileError
    {
        int pc = code.currentPc();
        if (rtype == com.octopus.utils.cls.javassist.CtClass.voidType) {
            ...
            if (rtype.isPrimitive())
                code.addOpcode(((com.octopus.utils.cls.javassist.CtPrimitiveType)rtype).getReturnOp());
            else
    ...
    private int insertAfterHandler(boolean asFinally, Bytecode b,
                                   com.octopus.utils.cls.javassist.CtClass rtype, int returnVarNo,
    ...
    */
     ...
     *                          catch clause.
     */
    public void addCatch(String src, com.octopus.utils.cls.javassist.CtClass exceptionType)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
     ...
     *
     * @see com.octopus.utils.cls.javassist.CtBehavior#insertAt(int,boolean,String)
     */
        ...
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        ...
        if (ainfo == null)
            throw new com.octopus.utils.cls.javassist.CannotCompileException("no line number info");
