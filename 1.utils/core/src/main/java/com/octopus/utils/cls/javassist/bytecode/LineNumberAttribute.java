 ...
 */
public class LineNumberAttribute extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     * The name of this attribute <code>"LineNumberTable"</code>.
     */
    public static final String tag = "LineNumberTable";

    LineNumberAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }

    private LineNumberAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, byte[] i) {
        super(cp, tag, i);
    }
