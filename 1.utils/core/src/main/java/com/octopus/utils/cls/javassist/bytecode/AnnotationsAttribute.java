...
import com.octopus.utils.cls.javassist.bytecode.annotation.*;
 ...
 * @see com.octopus.utils.cls.javassist.bytecode.annotation.Annotation
 */
public class AnnotationsAttribute extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     ...
     */
    public AnnotationsAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, String attrname, byte[] info) {
     ...
     * @param attrname      attribute name (<code>visibleTag</code> or
     *                      <code>invisibleTag</code>).
     * @see #setAnnotations(com.octopus.utils.cls.javassist.bytecode.annotation.Annotation[])
     */
    public AnnotationsAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, String attrname) {
     ...
     */
    AnnotationsAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }
    ...
    static class Renamer extends Walker {
        com.octopus.utils.cls.javassist.bytecode.ConstPool cpool;
        Map classnames;
         ...
         *                  It can be null.
         */
        Renamer(byte[] info, com.octopus.utils.cls.javassist.bytecode.ConstPool cp, Map map) {
            super(info);
            cpool = cp;
            classnames = map;
        }
        ...
        private void renameType(int pos, int index) {
            ...
            String newName = com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(name, classnames);
    ...
    static class Copier extends Walker {
        ...
        com.octopus.utils.cls.javassist.bytecode.ConstPool srcPool, destPool;
        Map classnames;
         ...
         *                  It can be null.
         */
        Copier(byte[] info, com.octopus.utils.cls.javassist.bytecode.ConstPool src, com.octopus.utils.cls.javassist.bytecode.ConstPool dest, Map map) {
            super(info);
    ...
    static class Parser extends Walker {
        com.octopus.utils.cls.javassist.bytecode.ConstPool pool;
         ...
         */
        Parser(byte[] info, com.octopus.utils.cls.javassist.bytecode.ConstPool cp) {
            super(info);
            pool = cp;
        }
