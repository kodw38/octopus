...
public class ExceptionTable implements Cloneable {
    private com.octopus.utils.cls.javassist.bytecode.ConstPool constPool;
     ...
     */
    public ExceptionTable(com.octopus.utils.cls.javassist.bytecode.ConstPool cp) {
        constPool = cp;
        entries = new ArrayList();
    }

    ExceptionTable(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, DataInputStream in) throws IOException {
        constPool = cp;
     ...
     *                          class names.
     */
    public ExceptionTable copy(com.octopus.utils.cls.javassist.bytecode.ConstPool newCp, Map classnames) {
        ExceptionTable et = new ExceptionTable(newCp);
        com.octopus.utils.cls.javassist.bytecode.ConstPool srcCp = constPool;
        int len = size();
        for (int i = 0; i < len; ++i) {
