...
import com.octopus.utils.cls.javassist.CtPrimitiveType;
...
/* Code generator accepting extended Java syntax for com.octopus.utils.cls.javassist.
 */
...
public class JvstCodeGen extends MemberCodeGen {
    ...
    public void atMember(Member mem) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (name.equals(paramArrayName)) {
            ...
            if (dollarType == null)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError(dollarTypeName + " is not available");
            ...
            if (param0Type == null)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError(clazzName + " is not available");
                        ...
                        ASTree right, boolean doDup) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        if (left instanceof Member
            ...
            if (op != '=')
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad operator for " + paramArrayName);

            right.accept(this);
            if (arrayDim != 1 || exprType != CLASS)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("invalid type for " + paramArrayName);
     ...
     */
    protected void atCastToRtype(CastExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (exprType == VOID || isRefType(exprType) || arrayDim > 0)
            ...
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("invalid cast");
    }

    protected void atCastToWrapper(CastExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        expr.getOprand().accept(this);
    ...
    /* To support $cflow().
     */
    protected void atCflow(ASTList cname) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        StringBuffer sbuf = new StringBuffer();
        if (cname == null || cname.tail() != null)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad " + cflowName);

        makeCflowName(sbuf, cname.head());
        String name = sbuf.toString();
        Object[] names = resolver.getClassPool().lookupCflow(name);
        if (names == null)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("no such " + cflowName + ": " + name);

        bytecode.addGetstatic((String)names[0], (String)names[1],
                              "Ljavassist/runtime/Cflow;");
        bytecode.addInvokevirtual("com.octopus.utils.cls.javassist.runtime.Cflow",
                                  "value", "()I");
        exprType = INT;
        arrayDim = 0;
        className = null;
    ...
    */
    ...
    public int recordReturnType(CtClass type, String castName,
                 String resultName, com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        returnType = type;
    ...
    public int recordParams(CtClass[] params, boolean isStatic,
                             ...
                             String paramsName, com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    public int recordParams(CtClass[] params, boolean isStatic,
                            ...
                            com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int varNo;
     ...
     */
    public int recordVariable(CtClass type, String varName, com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        if (varName == null)
            return -1;
    ...
    private int recordVar(CtClass cc, String varName, int varNo,
                          com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        if (exprType == VOID)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("invalid type for " + returnCastName);
     ...
     */
    public void setType(CtClass type) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        setType(type, 0);
    }

    private void setType(CtClass type, int dim) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (type.isPrimitive()) {
            CtPrimitiveType pt = (CtPrimitiveType)type;
            ...
            try {
                ...
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("undefined type: " + type.getName());
            }
        else {
            exprType = CLASS;
            arrayDim = dim;
     ...
     */
    public void doNumCast(CtClass type) throws com.octopus.utils.cls.javassist.compiler.CompileError {
