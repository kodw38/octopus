...
/* Code generator methods depending on com.octopus.utils.cls.javassist.* classes.
 */
public class MemberCodeGen extends CodeGen {
    ...
    protected void insertDefaultSuperCall() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        bytecode.addAload(0);
        bytecode.addInvokespecial(com.octopus.utils.cls.javassist.compiler.MemberResolver.getSuperclass(thisClass),
                                  "<init>", "()V");
    }
    ...
    protected void atTryStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (start == end)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("empty try block");
        ...
        while (catchList != null) {
            ...
            decl.setClassName(com.octopus.utils.cls.javassist.compiler.MemberResolver.javaToJvmName(type.getName()));
    ...
    private void atNewArrayExpr2(int type, ASTree sizeExpr,
                        String jvmClassname, ArrayInit init) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (init == null)
            if (sizeExpr == null)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("no array size");
            else
            ...
            if (sizeExpr == null) {
                ...
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("unnecessary array size specified for new");

        String elementClass;
        if (type == CLASS) {
            elementClass = resolveClassName(jvmClassname);
            bytecode.addAnewarray(com.octopus.utils.cls.javassist.compiler.MemberResolver.jvmToJavaName(elementClass));
        }
        else {
            elementClass = null;
            int atype = 0;
    ...
    private static void badNewExpr() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad new expression");
    }

    protected void atArrayVariableAssign(ArrayInit init, int varType,
                                         int varArray, String varClass) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    public void atArrayInit(ArrayInit init) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("array initializer is not supported");
    }
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        for (count = 0; size != null; size = size.tail()) {
            ...
            s.accept(this);
            if (exprType != INT)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad type for array size");
        }
    ...
    public void atCallExpr(CallExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        com.octopus.utils.cls.javassist.compiler.MemberResolver.Method cached = expr.getMethod();
        if (method instanceof Member) {
            ...
            targetClass = thisClass;
            if (inStaticMethod)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("a constructor cannot be static");
            else
                bytecode.addAload(0);   // this

            if (((Keyword)method).get() == SUPER)
                targetClass = com.octopus.utils.cls.javassist.compiler.MemberResolver.getSuperclass(targetClass);
        }
    ...
    public void atMethodCallCore(CtClass targetClass, String mname,
                        ...
                        int aload0pos, com.octopus.utils.cls.javassist.compiler.MemberResolver.Method found)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        if (mname.equals(MethodInfo.nameInit)) {
            ...
            if (declClass != targetClass)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("no such constructor: " + targetClass.getName());
        ...
        if ((acc & AccessFlag.STATIC) != 0) {
            ...
            if (declClass.isInterface())
                ...
                if (isStatic)
                    throw new com.octopus.utils.cls.javassist.compiler.CompileError(mname + " is not static");
                else
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        if (isEnclosing(declClass, thisClass)) {
            com.octopus.utils.cls.javassist.compiler.AccessorMaker maker = declClass.getAccessorMaker();
            if (maker != null)
                return maker.getMethodAccessor(methodName, desc, newDesc,
                                               minfo);
        }

        throw new com.octopus.utils.cls.javassist.compiler.CompileError("Method " + methodName
                               + " is private");
    }
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("the called constructor is private in "
                               + declClass.getName());
    }
                        ...
                        ASTree right, boolean doDup) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        if (op == '=') {
            ...
            setFieldType(finfo);
            com.octopus.utils.cls.javassist.compiler.AccessorMaker maker = isAccessibleField(f, finfo);
            if (maker == null)
    ...
    private void atFieldAssignCore(CtField f, boolean is_static, int fi,
                                   boolean is2byte) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (fi != 0) {
            if (is_static) {
    ...
    protected void atFieldRead(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    private void atArrayLength(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (arrayDim == 0)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError(".length applied to a non array");
     ...
     */
    private int atFieldRead(CtField f, boolean isStatic) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        FieldInfo finfo = f.getFieldInfo2();
     ...
     * one declared in an enclosing class.
     */
    private com.octopus.utils.cls.javassist.compiler.AccessorMaker isAccessibleField(CtField f, FieldInfo finfo)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        if (AccessFlag.isPrivate(finfo.getAccessFlags())
            ...
            if (isEnclosing(declClass, thisClass)) {
                ...
                if (maker != null)
                    ...
                    throw new com.octopus.utils.cls.javassist.compiler.CompileError("fatal error.  bug?");
            }
            else
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("Field " + f.getName() + " in "
     ...
     */
    private boolean setFieldType(FieldInfo finfo) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    private static void badLvalue() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad l-value");
    }

    public CtClass[] makeParamList(MethodDecl md) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        CtClass[] params;
    ...
    public CtClass[] makeThrowsList(MethodDecl md) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        CtClass[] clist;
