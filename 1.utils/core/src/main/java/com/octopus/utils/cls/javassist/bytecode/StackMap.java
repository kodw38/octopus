 ...
 *
 * @see com.octopus.utils.cls.javassist.bytecode.MethodInfo#doPreverify
 * @see com.octopus.utils.cls.javassist.bytecode.StackMapTable
 * @since 3.12
 */
public class StackMap extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     ...
     */
    StackMap(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, byte[] newInfo) {
        super(cp, tag, newInfo);
    }

    StackMap(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int name_id, DataInputStream in)
        throws IOException
    {
        super(cp, name_id, in);
    }
    ...
    static class Copier extends Walker {
        byte[] dest;
        com.octopus.utils.cls.javassist.bytecode.ConstPool srcCp, destCp;
        Map classnames;

        Copier(StackMap map, com.octopus.utils.cls.javassist.bytecode.ConstPool newCp, Map classnames) {
            super(map);
     ...
     * @see com.octopus.utils.cls.javassist.bytecode.StackMapTable#typeTagOf(char)
    ...
    public static class Writer {
        // see com.octopus.utils.cls.javassist.bytecode.stackmap.MapMaker
