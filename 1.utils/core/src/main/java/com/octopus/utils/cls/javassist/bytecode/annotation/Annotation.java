...
package com.octopus.utils.cls.javassist.bytecode.annotation;

import com.octopus.utils.cls.javassist.ClassPool;
import com.octopus.utils.cls.javassist.CtClass;
import com.octopus.utils.cls.javassist.CtMethod;
 ...
 *
 * @see com.octopus.utils.cls.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see com.octopus.utils.cls.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue
 * @see com.octopus.utils.cls.javassist.bytecode.annotation.MemberValueVisitor
 * @see com.octopus.utils.cls.javassist.bytecode.annotation.AnnotationsWriter
 *
...
public class Annotation {
    static class Pair {
        int name;
        com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue value;
    }
     ...
     *
     * @see #addMemberValue(String, com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue)
     */
     ...
     * @throws com.octopus.utils.cls.javassist.NotFoundException when the clazz is not found
     */
     ...
     * @throws com.octopus.utils.cls.javassist.NotFoundException when the type is not found
     */
    public static com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue createMemberValue(ConstPool cp, CtClass type)
        throws NotFoundException
    {
        if (type == CtClass.booleanType)
            ...
            com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue member = createMemberValue(cp, arrayType);
     ...
     */
    public void addMemberValue(int nameIndex, com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue value) {
        Pair p = new Pair();
        p.name = nameIndex;
        p.value = value;
        addMemberValue(p);
     ...
     * @param value     the member value.
     */
    public void addMemberValue(String name, com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue value) {
        Pair p = new Pair();
     ...
     * the default value.
     *
     * @see com.octopus.utils.cls.javassist.bytecode.AnnotationDefaultAttribute
     */
    public com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue getMemberValue(String name) {
        if (members == null)
            return null;
        else {
     ...
     * @throws com.octopus.utils.cls.javassist.bytecode.annotation.NoSuchClassError         if the class linkage fails.
     */
     ...
     * @throws java.io.IOException for an error during the write
     */
