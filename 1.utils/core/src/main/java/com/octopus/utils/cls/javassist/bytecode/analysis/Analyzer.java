 ...
 * </pre>
 *
 * @see com.octopus.utils.cls.javassist.bytecode.analysis.FramePrinter
...
public class Analyzer implements Opcode {
     ...
     * @throws com.octopus.utils.cls.javassist.bytecode.BadBytecode if the bytecode does not comply with the JVM specification
     */
