...
public final class Parser implements com.octopus.utils.cls.javassist.compiler.TokenId {
    private com.octopus.utils.cls.javassist.compiler.Lex lex;
     ...
     */
    public ASTList parseMember(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     */
    public ASTList parseMember1(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     *    [ "=" expression ] ";"
     */
    private FieldDecl parseField(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, ASTList mods,
                                Declarator d) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ASTree expr = null;
        if (lex.lookAhead() == '=') {
            lex.get();
     ...
     */
    private MethodDecl parseMethod1(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, boolean isConstructor,
     ...
     */
    public MethodDecl parseMethod2(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, MethodDecl md)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        Stmnt body = null;
        if (lex.lookAhead() == ';')
     ...
     */
    private Declarator parseFormalType(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int t = lex.lookAhead();
     ...
     */
    private Declarator parseFormalParam(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
     ...
     */
    public Stmnt parseStatement(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int t = lex.lookAhead();
        if (t == '{')
     ...
     */
    private Stmnt parseBlock(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (lex.get() != '{')
            throw new SyntaxError(lex);

        Stmnt body = null;
        com.octopus.utils.cls.javassist.compiler.SymbolTable tbl2 = new com.octopus.utils.cls.javassist.compiler.SymbolTable(tbl);
        while (lex.lookAhead() != '}') {
     ...
     *                [ ELSE statement ]
     */
    private Stmnt parseIf(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int t = lex.get();      // IF
     ...
     */
    private Stmnt parseWhile(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int t = lex.get();      // WHILE
        ASTree expr = parseParExpression(tbl);
     ...
     */
    private Stmnt parseDo(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int t = lex.get();      // DO
        Stmnt body = parseStatement(tbl);
     ...
     *                 statement
     */
    private Stmnt parseFor(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        Stmnt expr1, expr3;
        ASTree expr2;
        int t = lex.get();      // FOR
        ...
        if (lex.get() != ';')
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("; is missing", lex);
     ...
     */
    private Stmnt parseSwitch(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    private Stmnt parseSwitchBlock(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (lex.get() != '{')
            throw new SyntaxError(lex);
        ...
        if (s == null)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("empty switch block", lex);

        int op = s.getOperator();
        if (op != CASE && op != DEFAULT)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("no case or default in a switch block",
                                   lex);
    ...
    private Stmnt parseStmntOrCase(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int t = lex.lookAhead();
        if (t != CASE && t != DEFAULT)
     ...
     */
    private Stmnt parseSynchronized(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     */
    private Stmnt parseTry(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        lex.get();      // TRY
     ...
     */
    private Stmnt parseReturn(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     */
    private Stmnt parseThrow(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int t = lex.get();      // THROW
        ASTree expr = parseExpression(tbl);
        if (lex.get() != ';')
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("; is missing", lex);
     ...
     */
    private Stmnt parseBreak(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        return parseContinue(tbl);
    }
     ...
     */
    private Stmnt parseContinue(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
     ...
     * in future.
     */
    private Stmnt parseDeclarationOrExpression(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl,
                                               boolean exprList)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int t = lex.lookAhead();
     ...
     */
    private Stmnt parseExprList(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        Stmnt expr = null;
        for (;;) {
     ...
     */
    private Stmnt parseDeclarators(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, Declarator d)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        Stmnt decl = null;
        for (;;) {
     ...
     */
    private Declarator parseDeclarator(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, Declarator d)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
     ...
     */
    private ASTree parseInitializer(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (lex.lookAhead() == '{')
     ...
     */
    private ArrayInit parseArrayInitializer(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        lex.get();      // '{'
        ASTree expr = parseExpression(tbl);
     ...
     */
    private ASTree parseParExpression(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (lex.get() != '(')
            throw new SyntaxError(lex);
     ...
     */
    public ASTree parseExpression(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     */
    private ASTree parseConditionalExpr(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     */
    private ASTree parseBinaryExpr(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    private ASTree parseInstanceOf(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, ASTree expr)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int t = lex.lookAhead();
        if (isBuiltinType(t)) {
    ...
    private ASTree binaryExpr2(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, ASTree expr, int prec)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int t = lex.get();
        if (t == INSTANCEOF)
    ...
    /* unary.expr : "++"|"--" unary.expr
       ...
       "+", "-", "++", or "--".
     */
    private ASTree parseUnaryExpr(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int t;
     ...
     */
    private ASTree parseCast(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    /* array.dimension : [ "[" "]" ]*
     */
    private int parseArrayDimension() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int arrayDim = 0;
        while (lex.lookAhead() == '[') {
            ++arrayDim;
            lex.get();
     ...
     */
    private ASTList parseClassType(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ASTList list = null;
        for (;;) {
            if (lex.get() != Identifier)
                throw new SyntaxError(lex);
     ...
     */
    private ASTree parsePostfix(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        while (true) {
            ...
            case '.' :
                ...
                if (t == CLASS) {
                    ...
                    throw new com.octopus.utils.cls.javassist.compiler.CompileError("missing member name", lex);
                break;
            case '#' :
                lex.get();
                t = lex.get();
                if (t != Identifier)
                    throw new com.octopus.utils.cls.javassist.compiler.CompileError("missing static member name", lex);
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        if (dim > 0) {
            ...
            case VOID :
                ...
                break;
            default :
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("invalid builtin type: "
                                       + builtinType);
            }
     ...
     *             | postfix.expr "#" Identifier
     */
    private ASTree parseMethodCall(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl, ASTree expr)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad static member access", lex);
    }
     ...
     * or a class name.
     */
    private ASTree parsePrimaryExpr(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int t;
        String name;
        Declarator decl;
        ASTree expr;
     ...
     */
    private NewExpr parseNew(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ArrayInit init = null;
        int t = lex.lookAhead();
        if (isBuiltinType(t)) {
            lex.get();
     ...
     */
    private ASTList parseArraySize(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ASTList list = null;
        while (lex.lookAhead() == '[')
     ...
     */
    private ASTree parseArrayIndex(com.octopus.utils.cls.javassist.compiler.SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        lex.get();      // '['
        if (lex.lookAhead() == ']') {
            lex.get();
            return null;
     ...
     */
    private ASTList parseArgumentList(SymbolTable tbl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (lex.get() != '(')
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("( is missing", lex);
