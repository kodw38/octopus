...
import com.octopus.utils.cls.javassist.bytecode.annotation.AnnotationsWriter;
import com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue;
 ...
 * </pre></ul>
 *
 * @see com.octopus.utils.cls.javassist.bytecode.AnnotationsAttribute
 * @see com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue
 */

public class AnnotationDefaultAttribute extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     ...
     */
    public AnnotationDefaultAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, byte[] info) {
        super(cp, tag, info);
    }
     ...
     *
     * @param cp            constant pool
     * @see #setDefaultValue(com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue)
     */
    public AnnotationDefaultAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp) {
     ...
     */
    AnnotationDefaultAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }
    ...
    public com.octopus.utils.cls.javassist.bytecode.AttributeInfo copy(com.octopus.utils.cls.javassist.bytecode.ConstPool newCp, Map classnames) {
        com.octopus.utils.cls.javassist.bytecode.AnnotationsAttribute.Copier copier
            = new com.octopus.utils.cls.javassist.bytecode.AnnotationsAttribute.Copier(info, constPool, newCp, classnames);
        try {
     ...
     * @see com.octopus.utils.cls.javassist.bytecode.annotation.Annotation#createMemberValue(com.octopus.utils.cls.javassist.bytecode.ConstPool, com.octopus.utils.cls.javassist.CtClass)
     */
