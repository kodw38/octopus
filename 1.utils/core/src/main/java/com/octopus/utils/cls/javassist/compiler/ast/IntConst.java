 ...
 * Integer constant.
 */
public class IntConst extends com.octopus.utils.cls.javassist.compiler.ast.ASTree {
    ...
    public com.octopus.utils.cls.javassist.compiler.ast.ASTree compute(int op, com.octopus.utils.cls.javassist.compiler.ast.ASTree right) {
        if (right instanceof IntConst)
            return compute0(op, (IntConst)right);
        else if (right instanceof com.octopus.utils.cls.javassist.compiler.ast.DoubleConst)
            return compute0(op, (com.octopus.utils.cls.javassist.compiler.ast.DoubleConst)right);
        else
            return null;
    }
    ...
    private com.octopus.utils.cls.javassist.compiler.ast.DoubleConst compute0(int op, com.octopus.utils.cls.javassist.compiler.ast.DoubleConst right) {
