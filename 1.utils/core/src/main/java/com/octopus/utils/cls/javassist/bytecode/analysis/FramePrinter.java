...
public final class FramePrinter {
    ...
    public void print(CtMethod method) {
        ...
        com.octopus.utils.cls.javassist.bytecode.analysis.Frame[] frames;
        try {
            frames = (new com.octopus.utils.cls.javassist.bytecode.analysis.Analyzer()).analyze(method.getDeclaringClass(), info);
        } catch (BadBytecode e) {
            throw new RuntimeException(e);
        }
        ...
        while (iterator.hasNext()) {
            ...
            com.octopus.utils.cls.javassist.bytecode.analysis.Frame frame = frames[pos];
            if (frame == null) {
    ...
    private void printStack(com.octopus.utils.cls.javassist.bytecode.analysis.Frame frame) {
        stream.print("stack [");
