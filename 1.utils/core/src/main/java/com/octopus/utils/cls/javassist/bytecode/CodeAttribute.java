 ...
 *
 * @see com.octopus.utils.cls.javassist.bytecode.CodeIterator
 * @see #iterator()
 */
public class CodeAttribute extends AttributeInfo implements com.octopus.utils.cls.javassist.bytecode.Opcode {
    /**
     ...
     * @param classnames        pairs of replaced and substituted
     *                          class names.
     * @exception com.octopus.utils.cls.javassist.bytecode.CodeAttribute.RuntimeCopyException  if a <code>BadBytecode</code>
     ...
     *
     * @throws com.octopus.utils.cls.javassist.bytecode.BadBytecode      if this method fails in computing.
     * @return the newly computed value of <code>max_stack</code>
     */
    public int computeMaxStack() throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
     ...
     *
     * @see com.octopus.utils.cls.javassist.bytecode.LocalVariableAttribute#shiftIndex(int, int)
     * @see com.octopus.utils.cls.javassist.bytecode.LocalVariableTypeAttribute#shiftIndex(int, int)
     * @see com.octopus.utils.cls.javassist.bytecode.StackMapTable#insertLocal(int, int, int)
     * @see com.octopus.utils.cls.javassist.bytecode.StackMap#insertLocal(int, int, int)
     */
    public void insertLocalVar(int where, int size) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
     ...
     */
    private static void shiftIndex(CodeIterator ci, int lessThan, int delta) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        int index = ci.next();
