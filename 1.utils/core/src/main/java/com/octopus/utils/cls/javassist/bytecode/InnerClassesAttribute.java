 ...
 */
public class InnerClassesAttribute extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     * The name of this attribute <code>"InnerClasses"</code>.
     */
    public static final String tag = "InnerClasses";

    InnerClassesAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }

    private InnerClassesAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, byte[] info) {
        super(cp, tag, info);
    }
     ...
     */
    public InnerClassesAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp) {
