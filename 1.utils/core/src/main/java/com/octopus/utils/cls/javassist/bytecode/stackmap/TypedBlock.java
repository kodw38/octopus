...
public class TypedBlock extends com.octopus.utils.cls.javassist.bytecode.stackmap.BasicBlock {
    ...
    public static class Maker extends com.octopus.utils.cls.javassist.bytecode.stackmap.BasicBlock.Maker {
        protected com.octopus.utils.cls.javassist.bytecode.stackmap.BasicBlock makeBlock(int pos) {
            return new TypedBlock(pos);
        }

        protected com.octopus.utils.cls.javassist.bytecode.stackmap.BasicBlock[] makeArray(int size) {
     ...
     *                          For example, <code>com.octopus.utils.cls.javassist.bytecode.stackmap.BasicBlock</code>.
