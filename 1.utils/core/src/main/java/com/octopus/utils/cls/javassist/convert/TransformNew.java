...
final public class TransformNew extends com.octopus.utils.cls.javassist.convert.Transformer {
    private int nested;
    private String classname, trapClass, trapMethod;

    public TransformNew(com.octopus.utils.cls.javassist.convert.Transformer next,
