...
import com.octopus.utils.cls.javassist.CannotCompileException;
 ...
 * typechecking.
 *
 * @see com.octopus.utils.cls.javassist.bytecode.StackMap
 * @since 3.4
 */
public class StackMapTable extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     ...
     */
    StackMapTable(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, byte[] newInfo) {
        super(cp, tag, newInfo);
    }

    StackMapTable(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int name_id, DataInputStream in)
        throws IOException
    {
        super(cp, name_id, in);
    }
     ...
     * Makes a copy.
     *
     * @exception com.octopus.utils.cls.javassist.bytecode.StackMapTable.RuntimeCopyException  if a <code>BadBytecode</code>
     *                          exception is thrown while copying,
     *                          it is converted into
     *                          <code>RuntimeCopyException</code>.
     *
     */
    public com.octopus.utils.cls.javassist.bytecode.AttributeInfo copy(com.octopus.utils.cls.javassist.bytecode.ConstPool newCp, Map classnames)
        throws RuntimeCopyException
    {
        ...
        catch (com.octopus.utils.cls.javassist.bytecode.BadBytecode e) {
    ...
    public static class Walker {
         ...
         */
        public void parse() throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
            int n = numOfEntries;
            int pos = 2;
            for (int i = 0; i < n; i++)
         ...
         */
        int stackMapFrames(int pos, int nth) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
            ...
            if (type < 64) {
                ...
                throw new com.octopus.utils.cls.javassist.bytecode.BadBytecode("bad frame_type in StackMapTable");
         ...
         * @param offsetDelta
         */
        public void sameFrame(int pos, int offsetDelta) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {}

        private int sameLocals(int pos, int type) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
            int top = pos;
            int offset;
            if (type < 128)
                offset = type - 64;
         ...
         */
        public void chopFrame(int pos, int offsetDelta, int k) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {}

        private int appendFrame(int pos, int type) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
            int k = type - 251;
            int offset = ByteArray.readU16bit(info, pos + 1);
            int[] tags = new int[k];
            int[] data = new int[k];
        ...
        private int fullFrame(int pos) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
            int offset = ByteArray.readU16bit(info, pos + 1);
    ...
    static class SimpleCopy extends Walker {
        ...
        public byte[] doit() throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
            parse();
    ...
    static class Copier extends SimpleCopy {
        private com.octopus.utils.cls.javassist.bytecode.ConstPool srcPool, destPool;
        private Map classnames;

        public Copier(com.octopus.utils.cls.javassist.bytecode.ConstPool src, byte[] data, com.octopus.utils.cls.javassist.bytecode.ConstPool dest, Map names) {
            super(data);
            srcPool = src;
            destPool = dest;
            classnames = names;
     ...
     *
     * @see com.octopus.utils.cls.javassist.CtBehavior#addParameter(com.octopus.utils.cls.javassist.CtClass)
     * @see #typeTagOf(char)
     * @see com.octopus.utils.cls.javassist.bytecode.ConstPool
     */
    ...
    static class Shifter extends Walker {
        ...
        public void doit() throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
            parse();
            if (updatedInfo != null)
    ...
    /**
     * @see com.octopus.utils.cls.javassist.bytecode.CodeIterator.Switcher#adjustOffsets(int, int)
     */
    void shiftForSwitch(int where, int gapSize) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
     ...
     *
     * <p>This method is for com.octopus.utils.cls.javassist.convert.TransformNew.
