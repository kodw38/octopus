 ...
 * The visitor pattern.
 *
 * @see ast.ASTree#accept(com.octopus.utils.cls.javassist.compiler.ast.Visitor)
 */
public class Visitor {
    public void atASTList(com.octopus.utils.cls.javassist.compiler.ast.ASTList n) throws CompileError {}
