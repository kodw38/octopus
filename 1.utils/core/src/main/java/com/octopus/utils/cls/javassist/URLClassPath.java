 ...
 * @see com.octopus.utils.cls.javassist.ClassPool#insertClassPath(com.octopus.utils.cls.javassist.ClassPath)
 * @see com.octopus.utils.cls.javassist.ClassPool#appendClassPath(com.octopus.utils.cls.javassist.ClassPath)
 */
public class URLClassPath implements com.octopus.utils.cls.javassist.ClassPath {
     ...
     * If <code>packageName</code> is "org.com.octopus.utils.cls.javassist." and a requested class is
     * "org.com.octopus.utils.cls.javassist.test.Main", then the given URL is used for loading that class.
     * The <code>URLClassPath</code> obtains a class file from:
     *
     * <ul><pre>http://www.com.octopus.utils.cls.javassist.org:80/java/classes/org/javassist/test/Main.class
     * </pre></ul>
     *
     * <p>Here, we assume that <code>host</code> is "www.com.octopus.utils.cls.javassist.org",
        ...
        throws IOException
    {
        ...
        try {
            if (size <= 0)
                b = com.octopus.utils.cls.javassist.ClassPoolTail.readStream(s);
            else {
                b = new byte[size];
                int len = 0;
                do {
