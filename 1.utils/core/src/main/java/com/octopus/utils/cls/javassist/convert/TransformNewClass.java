...
final public class TransformNewClass extends com.octopus.utils.cls.javassist.convert.Transformer {
    private int nested;
    private String classname, newClassName;
    private int newClassIndex, newMethodNTIndex, newMethodIndex;

    public TransformNewClass(com.octopus.utils.cls.javassist.convert.Transformer next,
