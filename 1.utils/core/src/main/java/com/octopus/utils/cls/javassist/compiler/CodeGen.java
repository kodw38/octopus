...
package com.octopus.utils.cls.javassist.compiler;

import com.octopus.utils.cls.javassist.bytecode.Bytecode;
import com.octopus.utils.cls.javassist.bytecode.Opcode;
import com.octopus.utils.cls.javassist.compiler.ast.*;
...
public abstract class CodeGen extends Visitor implements Opcode, com.octopus.utils.cls.javassist.compiler.TokenId {
    ...
    protected static void fatal() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("fatal");
    }
     ...
     */
    protected abstract String getSuperName() throws com.octopus.utils.cls.javassist.compiler.CompileError;
    ...
    protected abstract String resolveClassName(ASTList name)
        throws com.octopus.utils.cls.javassist.compiler.CompileError;
    ...
    public void compileExpr(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        doTypeCheck(expr);
        expr.accept(this);
    }
    ...
    public void doTypeCheck(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (typeChecker != null)
            expr.accept(typeChecker);
    }

    public void atASTList(ASTList n) throws com.octopus.utils.cls.javassist.compiler.CompileError { fatal(); }
    
    public void atPair(Pair n) throws com.octopus.utils.cls.javassist.compiler.CompileError { fatal(); }

    public void atSymbol(Symbol n) throws com.octopus.utils.cls.javassist.compiler.CompileError { fatal(); }

    public void atFieldDecl(FieldDecl field) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        field.getInit().accept(this);
    }

    public void atMethodDecl(MethodDecl method) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        if (!hasReturned)
            if (isVoid) {
                ...
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("no return statement");
    }

    private boolean needsSuperCall(Stmnt body) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    protected abstract void insertDefaultSuperCall() throws com.octopus.utils.cls.javassist.compiler.CompileError;

    public void atStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (st == null)
            return;     // empty
        ...
        if (op == EXPR) {
        ...
        else if (op == com.octopus.utils.cls.javassist.compiler.TokenId.RETURN)
            atReturnStmnt(st);
        else if (op == THROW)
            atThrowStmnt(st);
        else if (op == TRY)
            ...
            hasReturned = false;
            throw new com.octopus.utils.cls.javassist.compiler.CompileError(
                "sorry, not supported statement: TokenId " + op);
        }
    }

    private void atIfStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ASTree expr = st.head();
    ...
    private void atWhileStmnt(Stmnt st, boolean notDo) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    private void atForStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ArrayList prevBreakList = breakList;
        ArrayList prevContList = continueList;
        breakList = new ArrayList();
        continueList = new ArrayList();
    ...
    private void atSwitchStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        compileExpr(st.head());
    ...
    private int computeLabel(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        doTypeCheck(expr);
        expr = TypeChecker.stripPlusExpr(expr);
        if (expr instanceof IntConst)
            return (int)((IntConst)expr).get();
        else
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad case label");
    }
    ...
    protected void atReturnStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        atReturnStmnt2(st.getLeft());
    }

    protected final void atReturnStmnt2(ASTree result) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int op;
        if (result == null)
            op = Opcode.RETURN;
        else {
    ...
    private void atThrowStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ASTree e = st.getLeft();
        compileExpr(e);
        if (exprType != CLASS || arrayDim > 0)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad throw statement");
     ...
     */
    protected void atTryStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        hasReturned = false;
    }

    private void atSyncStmnt(Stmnt st) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int nbreaks = getListSize(breakList);
        int ncontinues = getListSize(continueList);

        compileExpr(st.head());
        if (exprType != CLASS && arrayDim == 0)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad type expr for synchronized block");
    ...
    public void atDeclarator(Declarator d) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    public abstract void atNewExpr(NewExpr n) throws com.octopus.utils.cls.javassist.compiler.CompileError;

    public abstract void atArrayInit(ArrayInit init) throws com.octopus.utils.cls.javassist.compiler.CompileError;

    public void atAssignExpr(AssignExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    protected static void badAssign(Expr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        String msg;
        if (expr == null)
        ...
        throw new com.octopus.utils.cls.javassist.compiler.CompileError(msg);
    }
    ...
    private void atVariableAssign(Expr expr, int op, Variable var,
                                  ...
                                  boolean doDup) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    protected abstract void atArrayVariableAssign(ArrayInit init,
            int varType, int varArray, String varClass) throws com.octopus.utils.cls.javassist.compiler.CompileError;

    private void atArrayAssign(Expr expr, int op, Expr array,
                        ASTree right, boolean doDup) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    public void atCondExpr(CondExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (dim1 != arrayDim)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("type mismatch in ?:");
    ...
    public void atBinExpr(BinExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (k >= 0) {
            ...
            right.accept(this);
            if (dim1 != arrayDim)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("incompatible array types");
    ...
    private void atArithBinExpr(Expr expr, int token,
                                int index, int type1) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        if (arrayDim != 0)
            badTypes(expr);
    ...
    private void atStringConcatExpr(Expr expr, int type1, int dim1,
                                    String cname1) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int type2 = exprType;
        int dim2 = arrayDim;
    ...
    private void convToString(int type, int dim) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (isRefType(type) || dim > 0)
            ...
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("void type expression");
        else /* INT, BYTE, SHORT */
            bytecode.addInvokestatic(javaLangString, method,
                                     "(I)Ljava/lang/String;");
    }
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        if (op == EQ) {         // ==, !=, ...
            ...
            if (exprType != BOOLEAN || arrayDim != 0)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("boolean expr is required");
    ...
    static int getCompOperator(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (expr instanceof Expr) {
    ...
    private int compileOprands(BinExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        expr.oprand1().accept(this);
        int type1 = exprType;
        int dim1 = arrayDim;
    ...
    protected static void badTypes(Expr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("invalid types for " + expr.getName());
    }
    ...
    public void atCastExpr(CastExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    public void atInstanceOfExpr(InstanceOfExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        String cname = resolveClassName(expr.getClassName());
        String toClass = checkCastExpr(expr, cname);
    ...
    public void atExpr(Expr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (token == '.') {
            ...
            /* MEMBER ('#') is an extension by com.octopus.utils.cls.javassist.
    ...
    protected static void badType(Expr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("invalid type for " + expr.getName());
    }

    public abstract void atCallExpr(CallExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError;

    protected abstract void atFieldRead(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError;

    public void atClassObject(Expr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ASTree op1 = expr.oprand1();
        if (!(op1 instanceof Symbol))
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("fatal error: badly parsed .class expr");
        ...
        if (cname.startsWith("[")) {
            ...
            if (i >= 0) {
                ...
                if (!name.equals(name2)) {
                     ...
                     */
                    name2 = com.octopus.utils.cls.javassist.compiler.MemberResolver.jvmToJavaName(name2);
                    StringBuffer sbuf = new StringBuffer();
                    while (i-- >= 0)
                        sbuf.append('[');
            ...
            cname = resolveClassName(com.octopus.utils.cls.javassist.compiler.MemberResolver.javaToJvmName(cname));
     ...
     */
    protected void atClassObject2(String cname) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        */
        ...
        bytecode.growStack(1);
        bytecode.addInvokestatic("com.octopus.utils.cls.javassist.runtime.DotClass", "fail",
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        int dim = arrayDim;
        if (dim == 0)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad array access");

        String cname = className;

        index.accept(this);
        if (typePrecedence(exprType) != P_INT || arrayDim > 0)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad array index");
    ...
    public void atArrayPlusPlus(int token, boolean isPost,
                        Expr expr, boolean doDup) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    protected void atPlusPlusCore(int dup_code, boolean doDup,
                                  ...
                                  Expr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int t = exprType;
    ...
    protected abstract void atFieldPlusPlus(int token, boolean isPost,
                ASTree oprand, Expr expr, boolean doDup) throws com.octopus.utils.cls.javassist.compiler.CompileError;

    public abstract void atMember(Member n) throws com.octopus.utils.cls.javassist.compiler.CompileError;

    public void atVariable(Variable v) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    public void atKeyword(Keyword k) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        arrayDim = 0;
        int token = k.get();
        switch (token) {
        case TRUE :
        ...
        case SUPER :
            if (inStaticMethod)
                throw new com.octopus.utils.cls.javassist.compiler.CompileError("not-available: "
    ...
    public void atStringL(StringL s) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        exprType = CLASS;
        arrayDim = 0;
        className = jvmJavaLangString;
    ...
    public void atIntConst(IntConst i) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        arrayDim = 0;
        long value = i.get();
        int type = i.getType();
