...
public abstract class CtMember {
    ...
    protected com.octopus.utils.cls.javassist.CtClass declaringClass;
    ...
    protected CtMember(com.octopus.utils.cls.javassist.CtClass clazz) {
     ...
     *
     * @see com.octopus.utils.cls.javassist.CtMethod#nameReplaced()
     */
    void nameReplaced() {}
     ...
     */
    public com.octopus.utils.cls.javassist.CtClass getDeclaringClass() { return declaringClass; }

    /**
     * Returns true if this member is accessible from the given class.
     */
    public boolean visibleFrom(com.octopus.utils.cls.javassist.CtClass clazz) {
        int mod = getModifiers();
        if (com.octopus.utils.cls.javassist.Modifier.isPublic(mod))
            return true;
        else if (com.octopus.utils.cls.javassist.Modifier.isPrivate(mod))
            ...
            if (!visible && com.octopus.utils.cls.javassist.Modifier.isProtected(mod))
     ...
     * @return an array of annotation-type objects.
     * @see #getAnnotations()
     * @see com.octopus.utils.cls.javassist.CtClass#getAvailableAnnotations()
     * @since 3.3
     */
     ...
     *
     * @see com.octopus.utils.cls.javassist.CtConstructor#getName()
     */
     ...
     * @see com.octopus.utils.cls.javassist.bytecode.SignatureAttribute#toMethodSignature(String)
     * @see com.octopus.utils.cls.javassist.CtClass#getGenericSignature()
     * @since 3.17
     */
     ...
     * @see com.octopus.utils.cls.javassist.CtClass#setGenericSignature(String)
     * @since 3.17
     */
