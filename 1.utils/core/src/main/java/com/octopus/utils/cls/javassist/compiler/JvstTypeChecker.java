...
/* Type checker accepting extended Java syntax for com.octopus.utils.cls.javassist.
 */

public class JvstTypeChecker extends TypeChecker {
    private com.octopus.utils.cls.javassist.compiler.JvstCodeGen codeGen;

    public JvstTypeChecker(CtClass cc, ClassPool cp, com.octopus.utils.cls.javassist.compiler.JvstCodeGen gen) {
        super(cc, cp);
        codeGen = gen;
    }
    ...
    public void atMember(Member mem) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        else if (name.equals(com.octopus.utils.cls.javassist.compiler.JvstCodeGen.sigName)) {
            exprType = CLASS;
            arrayDim = 1;
            className = "java/lang/Class";
        }
        else if (name.equals(com.octopus.utils.cls.javassist.compiler.JvstCodeGen.dollarTypeName)
                 || name.equals(com.octopus.utils.cls.javassist.compiler.JvstCodeGen.clazzName)) {
            exprType = CLASS;
            arrayDim = 0;
            className = "java/lang/Class";
        }
    ...
    public void atCastExpr(CastExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (classname != null && expr.getArrayDim() == 0) {
            ...
            if (p instanceof Symbol && classname.tail() == null) {
                ...
                else if (typename.equals(com.octopus.utils.cls.javassist.compiler.JvstCodeGen.wrapperCastName)) {
    ...
    protected void atCastToRtype(CastExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (exprType == VOID || CodeGen.isRefType(exprType) || arrayDim > 0)
            ...
            int destType = com.octopus.utils.cls.javassist.compiler.MemberResolver.descToType(pt.getDescriptor());
            exprType = destType;
            arrayDim = 0;
            className = null;
        }
    ...
    public void atCallExpr(CallExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (method instanceof Member) {
            ...
            else if (name.equals(com.octopus.utils.cls.javassist.compiler.JvstCodeGen.cflowName)) {
    ...
    protected void compileUnwrapValue(CtClass type) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    private void setType(CtClass type, int dim) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (type.isPrimitive()) {
            ...
            exprType = com.octopus.utils.cls.javassist.compiler.MemberResolver.descToType(pt.getDescriptor());
            arrayDim = dim;
            className = null;
        }
