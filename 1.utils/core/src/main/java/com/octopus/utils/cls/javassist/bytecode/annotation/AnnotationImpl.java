...
import com.octopus.utils.cls.javassist.bytecode.AnnotationDefaultAttribute;
...
public class AnnotationImpl implements InvocationHandler {
    ...
    private com.octopus.utils.cls.javassist.bytecode.annotation.Annotation annotation;
    ...
    public static Object make(ClassLoader cl, Class clazz, ClassPool cp,
                              com.octopus.utils.cls.javassist.bytecode.annotation.Annotation anon) {
        AnnotationImpl handler = new AnnotationImpl(anon, cp, cl);
        return Proxy.newProxyInstance(cl, new Class[] { clazz }, handler);
    }
    
    private AnnotationImpl(com.octopus.utils.cls.javassist.bytecode.annotation.Annotation a, ClassPool cp, ClassLoader loader) {
        annotation = a;
        pool = cp;
        classLoader = loader;
    }
     ...
     * @return the annotation
     */
    public com.octopus.utils.cls.javassist.bytecode.annotation.Annotation getAnnotation() {
        return annotation;
    }
        ...
        throws Throwable
    {
        ...
        com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue mv = annotation.getMemberValue(name);
        if (mv == null)
        ...
        if (pool != null) {
            try {
                ...
                if (minfo != null) {
                    ...
                    if (ainfo != null) {
                        com.octopus.utils.cls.javassist.bytecode.annotation.MemberValue mv = ainfo.getDefaultValue();
                        return mv.getValue(classLoader, pool, method);
                    }
                }
            }
