...
public class Type {
     ...
     * type can be assigned. If there is more than one possible answer, then a {@link com.octopus.utils.cls.javassist.bytecode.analysis.MultiType},
     * or a {@link com.octopus.utils.cls.javassist.bytecode.analysis.MultiArrayType} is returned. Multi-types have special rules,
