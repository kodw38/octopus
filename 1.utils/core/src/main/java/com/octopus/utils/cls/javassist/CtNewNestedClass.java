...
import com.octopus.utils.cls.javassist.bytecode.InnerClassesAttribute;

/**
 * A newly created public nested class.
 */
class CtNewNestedClass extends CtNewClass {
    CtNewNestedClass(String realName, com.octopus.utils.cls.javassist.ClassPool cp, boolean isInterface,
                     com.octopus.utils.cls.javassist.CtClass superclass) {
    ...
    private static void updateInnerEntry(int mod, String name, com.octopus.utils.cls.javassist.CtClass clazz, boolean outer) {
