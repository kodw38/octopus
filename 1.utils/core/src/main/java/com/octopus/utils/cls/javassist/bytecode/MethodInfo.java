...
import com.octopus.utils.cls.javassist.bytecode.stackmap.MapMaker;
 ...
 * @see com.octopus.utils.cls.javassist.CtMethod#getMethodInfo()
 * @see com.octopus.utils.cls.javassist.CtConstructor#getMethodInfo()
 */
public class MethodInfo {
    ...
    public MethodInfo(ConstPool cp, String methodname, MethodInfo src,
            Map classnameMap) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        this(cp);
     ...
     */
    public com.octopus.utils.cls.javassist.bytecode.CodeAttribute getCodeAttribute() {
        AttributeInfo info = AttributeInfo.lookup(attribute, com.octopus.utils.cls.javassist.bytecode.CodeAttribute.tag);
        return (com.octopus.utils.cls.javassist.bytecode.CodeAttribute)info;
    }
    ...
    public void removeCodeAttribute() {
        AttributeInfo.remove(attribute, com.octopus.utils.cls.javassist.bytecode.CodeAttribute.tag);
    }
     ...
     * <code>method_info</code> structure.
     */
    public void setCodeAttribute(com.octopus.utils.cls.javassist.bytecode.CodeAttribute cattr) {
        removeCodeAttribute();
        if (attribute == null)
            attribute = new ArrayList();
     ...
     * @see #rebuildStackMap(com.octopus.utils.cls.javassist.ClassPool)
     * @see #rebuildStackMapForME(com.octopus.utils.cls.javassist.ClassPool)
     * @see #doPreverify
     * @since 3.6
     */
    public void rebuildStackMapIf6(ClassPool pool, com.octopus.utils.cls.javassist.bytecode.ClassFile cf)
     ...
     * @since 3.6
     */
    public void rebuildStackMap(ClassPool pool) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        com.octopus.utils.cls.javassist.bytecode.CodeAttribute ca = getCodeAttribute();
        if (ca != null) {
     ...
     * @since 3.12
     */
    public void rebuildStackMapForME(ClassPool pool) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        com.octopus.utils.cls.javassist.bytecode.CodeAttribute ca = getCodeAttribute();
        if (ca != null) {
     ...
     *            the new super class
     */
    public void setSuperclass(String superclass) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        if (!isConstructor())
            return;
