...
import com.octopus.utils.cls.javassist.compiler.SymbolTable;
import com.octopus.utils.cls.javassist.compiler.ast.ASTree;
import com.octopus.utils.cls.javassist.compiler.ast.DoubleConst;
import com.octopus.utils.cls.javassist.compiler.ast.IntConst;
import com.octopus.utils.cls.javassist.compiler.ast.StringL;

/**
 * An instance of CtField represents a field.
 *
 * @see com.octopus.utils.cls.javassist.CtClass#getDeclaredFields()
 */
public class CtField extends CtMember {
     ...
     *
     * @see com.octopus.utils.cls.javassist.CtClass#addField(com.octopus.utils.cls.javassist.CtField)
     * @see com.octopus.utils.cls.javassist.CtNewMethod#getter(String, com.octopus.utils.cls.javassist.CtField)
     * @see com.octopus.utils.cls.javassist.CtNewMethod#setter(String, com.octopus.utils.cls.javassist.CtField)
     * @see com.octopus.utils.cls.javassist.CtField.Initializer
     */
    public CtField(com.octopus.utils.cls.javassist.CtClass type, String name, com.octopus.utils.cls.javassist.CtClass declaring)
     ...
     * @see com.octopus.utils.cls.javassist.CtField.Initializer
     */
    public CtField(CtField src, com.octopus.utils.cls.javassist.CtClass declaring)
        throws CannotCompileException
    {
    ...
    private CtField(String typeDesc, String name, com.octopus.utils.cls.javassist.CtClass clazz)
        throws CannotCompileException
    {
        super(clazz);
    ...
    CtField(FieldInfo fi, com.octopus.utils.cls.javassist.CtClass clazz) {
        super(clazz);
        fieldInfo = fi;
    }
     ...
     */
    public static CtField make(String src, com.octopus.utils.cls.javassist.CtClass declaring)
        throws CannotCompileException
    {
     ...
     *
     * @see #getFieldInfo()
     * @see com.octopus.utils.cls.javassist.CtClass#isFrozen()
     ...
     */
    public com.octopus.utils.cls.javassist.CtClass getDeclaringClass() {
     ...
     * a descriptor.
     *
     * @see com.octopus.utils.cls.javassist.bytecode.Descriptor
     ...
     *
     * @see com.octopus.utils.cls.javassist.bytecode.SignatureAttribute#toFieldSignature(String)
     * @since 3.17
     */
     ...
     * It represents a type including type variables.
     * See {@link com.octopus.utils.cls.javassist.CtClass#setGenericSignature(String)}
     * for a code sample.
     *
     * @param sig       a new generic signature.
     * @see com.octopus.utils.cls.javassist.bytecode.SignatureAttribute.ObjectType#encode()
     * @since 3.17
     */
     ...
     */
    public com.octopus.utils.cls.javassist.CtClass getType() throws NotFoundException {
     ...
     */
    public void setType(com.octopus.utils.cls.javassist.CtClass clazz) {
        declaringClass.checkModify();
     ...
     * See {@link com.octopus.utils.cls.javassist.bytecode.AttributeInfo}.
     *
     ...
     *
     * @see com.octopus.utils.cls.javassist.CtClass#addField(com.octopus.utils.cls.javassist.CtField, com.octopus.utils.cls.javassist.CtField.Initializer)
     */
    public static abstract class Initializer {
         ...
         */
        public static Initializer byNew(com.octopus.utils.cls.javassist.CtClass objectType) {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see com.octopus.utils.cls.javassist.CtField.Initializer#byNewArray(com.octopus.utils.cls.javassist.CtClass,int)
         * @see com.octopus.utils.cls.javassist.CtField.Initializer#byNewArray(com.octopus.utils.cls.javassist.CtClass,int[])
         */
        public static Initializer byNewWithParams(com.octopus.utils.cls.javassist.CtClass objectType) {
            NewInitializer i = new NewInitializer();
            i.objectType = objectType;
            i.stringParams = null;
         ...
         */
        public static Initializer byCall(com.octopus.utils.cls.javassist.CtClass methodClass,
                                              String methodName) {
         ...
         * @param methodName    the name of the satic method.
         */
        public static Initializer byCallWithParams(com.octopus.utils.cls.javassist.CtClass methodClass,
                                                        String methodName) {
            MethodInitializer i = new MethodInitializer();
            i.objectType = methodClass;
            i.methodName = methodName;
         ...
         * @throws com.octopus.utils.cls.javassist.NotFoundException    if the type of the array components
         *                              is not found.
         */
        public static Initializer byNewArray(com.octopus.utils.cls.javassist.CtClass type, int size)
         ...
         */
        public static Initializer byNewArray(com.octopus.utils.cls.javassist.CtClass type, int[] sizes) {
        ...
        abstract int compile(com.octopus.utils.cls.javassist.CtClass type, String name, Bytecode code,
                             com.octopus.utils.cls.javassist.CtClass[] parameters, Javac drv)
            throws CannotCompileException;

        // produce codes for initialization
        abstract int compileIfStatic(com.octopus.utils.cls.javassist.CtClass type, String name,
        ...
        int getConstantValue(ConstPool cp, com.octopus.utils.cls.javassist.CtClass type) { return 0; }
    }

    static abstract class CodeInitializer0 extends Initializer {
        abstract void compileExpr(Javac drv) throws CompileError;

        int compile(com.octopus.utils.cls.javassist.CtClass type, String name, Bytecode code,
                    com.octopus.utils.cls.javassist.CtClass[] parameters, Javac drv)
            throws CannotCompileException
        {
            try {
        ...
        int compileIfStatic(com.octopus.utils.cls.javassist.CtClass type, String name, Bytecode code,
        ...
        int getConstantValue2(ConstPool cp, com.octopus.utils.cls.javassist.CtClass type, ASTree tree) {
            if (type.isPrimitive()) {
                if (tree instanceof IntConst) {
                    long value = ((IntConst)tree).get();
                    if (type == com.octopus.utils.cls.javassist.CtClass.doubleType)
                        return cp.addDoubleInfo((double)value);
                    else if (type == com.octopus.utils.cls.javassist.CtClass.floatType)
                        return cp.addFloatInfo((float)value);
                    else if (type == com.octopus.utils.cls.javassist.CtClass.longType)
                        return cp.addLongInfo(value);
                    else  if (type != com.octopus.utils.cls.javassist.CtClass.voidType)
                        return cp.addIntegerInfo((int)value);
                }
                else if (tree instanceof DoubleConst) {
                    double value = ((DoubleConst)tree).get();
                    if (type == com.octopus.utils.cls.javassist.CtClass.floatType)
                        return cp.addFloatInfo((float)value);
                    else if (type == com.octopus.utils.cls.javassist.CtClass.doubleType)
    ...
    static class CodeInitializer extends CodeInitializer0 {
        ...
        int getConstantValue(ConstPool cp, com.octopus.utils.cls.javassist.CtClass type) {
            try {
    ...
    static class ParamInitializer extends Initializer {
         ...
         */
        static int nthParamToLocal(int nth, com.octopus.utils.cls.javassist.CtClass[] params,
                                   boolean isStatic) {
            com.octopus.utils.cls.javassist.CtClass longType = com.octopus.utils.cls.javassist.CtClass.longType;
            com.octopus.utils.cls.javassist.CtClass doubleType = com.octopus.utils.cls.javassist.CtClass.doubleType;
            int k;
            if (isStatic)
                k = 0;
            else
            ...
            for (int i = 0; i < nth; ++i) {
                com.octopus.utils.cls.javassist.CtClass type = params[i];
    ...
    static class NewInitializer extends Initializer {
        com.octopus.utils.cls.javassist.CtClass objectType;
        String[] stringParams;
    ...
    static class LongInitializer extends Initializer {
        ...
        int getConstantValue(ConstPool cp, com.octopus.utils.cls.javassist.CtClass type) {
            if (type == com.octopus.utils.cls.javassist.CtClass.longType)
                return cp.addLongInfo(value);
            else
                return 0;
        }
    ...
    static class ArrayInitializer extends Initializer {
        com.octopus.utils.cls.javassist.CtClass type;
        int size;

        ArrayInitializer(com.octopus.utils.cls.javassist.CtClass t, int s) { type = t; size = s; }
    ...
    static class MultiArrayInitializer extends Initializer {
        ...
        MultiArrayInitializer(com.octopus.utils.cls.javassist.CtClass t, int[] d) { type = t; dim = d; }
