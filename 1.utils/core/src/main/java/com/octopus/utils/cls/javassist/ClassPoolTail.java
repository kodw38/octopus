...
final class ClassPathList {
    ClassPathList next;
    com.octopus.utils.cls.javassist.ClassPath path;

    ClassPathList(com.octopus.utils.cls.javassist.ClassPath p, ClassPathList n) {
        next = n;
        path = p;
    }
}

final class DirClassPath implements com.octopus.utils.cls.javassist.ClassPath {
    String directory;
...
final class JarDirClassPath implements com.octopus.utils.cls.javassist.ClassPath {
    JarClassPath[] jars;

    JarDirClassPath(String dirName) throws com.octopus.utils.cls.javassist.NotFoundException {
    ...
    public InputStream openClassfile(String classname) throws com.octopus.utils.cls.javassist.NotFoundException {
        if (jars != null)
...
final class JarClassPath implements com.octopus.utils.cls.javassist.ClassPath {
    JarFile jarfile;
    String jarfileURL;

    JarClassPath(String pathname) throws com.octopus.utils.cls.javassist.NotFoundException {
        try {
        ...
        throw new com.octopus.utils.cls.javassist.NotFoundException(pathname);
    }
        ...
        throws com.octopus.utils.cls.javassist.NotFoundException
    {
        ...
        throw new com.octopus.utils.cls.javassist.NotFoundException("broken jar file?: "
                                    + jarfile.getName());
    }
...
final class ClassPoolTail {
    ...
    public synchronized com.octopus.utils.cls.javassist.ClassPath insertClassPath(com.octopus.utils.cls.javassist.ClassPath cp) {
        pathList = new ClassPathList(cp, pathList);
        return cp;
    }

    public synchronized com.octopus.utils.cls.javassist.ClassPath appendClassPath(com.octopus.utils.cls.javassist.ClassPath cp) {
    ...
    public synchronized void removeClassPath(com.octopus.utils.cls.javassist.ClassPath cp) {
        ClassPathList list = pathList;
        if (list != null)
            if (list.path == cp)
                pathList = list.next;
    ...
    public com.octopus.utils.cls.javassist.ClassPath appendSystemPath() {
        return appendClassPath(new com.octopus.utils.cls.javassist.ClassClassPath());
    }

    public com.octopus.utils.cls.javassist.ClassPath insertClassPath(String pathname)
        throws com.octopus.utils.cls.javassist.NotFoundException
    {
        return insertClassPath(makePathObject(pathname));
    }

    public com.octopus.utils.cls.javassist.ClassPath appendClassPath(String pathname)
        throws com.octopus.utils.cls.javassist.NotFoundException
    {
    ...
    void writeClassfile(String classname, OutputStream out)
        throws com.octopus.utils.cls.javassist.NotFoundException, IOException, CannotCompileException
    {
        InputStream fin = openClassfile(classname);
        if (fin == null)
            throw new com.octopus.utils.cls.javassist.NotFoundException(classname);
    ...
    */
     ...
     * @throws com.octopus.utils.cls.javassist.NotFoundException    if any error is reported by ClassPath.
     */
        ...
        throws com.octopus.utils.cls.javassist.NotFoundException
    {
        ...
        com.octopus.utils.cls.javassist.NotFoundException error = null;
        while (list != null) {
            try {
