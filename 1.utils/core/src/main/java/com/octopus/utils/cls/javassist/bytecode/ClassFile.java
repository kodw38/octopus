...
public final class ClassFile {
    ...
    public final void renameClass(String oldname, String newname) {
        ...
        oldname = com.octopus.utils.cls.javassist.bytecode.Descriptor.toJvmName(oldname);
        newname = com.octopus.utils.cls.javassist.bytecode.Descriptor.toJvmName(newname);
        ...
        for (int i = 0; i < n; ++i) {
            ...
            minfo.setDescriptor(com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(desc, oldname, newname));
        ...
        for (int i = 0; i < n; ++i) {
            ...
            finfo.setDescriptor(com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(desc, oldname, newname));
    ...
    public final void renameClass(Map classnames) {
        String jvmNewThisName = (String)classnames.get(com.octopus.utils.cls.javassist.bytecode.Descriptor
                .toJvmName(thisclassname));
        if (jvmNewThisName != null)
            thisclassname = com.octopus.utils.cls.javassist.bytecode.Descriptor.toJavaName(jvmNewThisName);
        ...
        for (int i = 0; i < n; ++i) {
            MethodInfo minfo = (MethodInfo)list.get(i);
            String desc = minfo.getDescriptor();
            minfo.setDescriptor(com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(desc, classnames));
        ...
        for (int i = 0; i < n; ++i) {
            FieldInfo finfo = (FieldInfo)list.get(i);
            String desc = finfo.getDescriptor();
            finfo.setDescriptor(com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(desc, classnames));
    ...
    public final void getRefClasses(Map classnames) {
        ...
        for (int i = 0; i < n; ++i) {
            MethodInfo minfo = (MethodInfo)list.get(i);
            String desc = minfo.getDescriptor();
            com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(desc, classnames);
     ...
     * @see com.octopus.utils.cls.javassist.bytecode.FieldInfo
     */
     ...
     *
     * @throws com.octopus.utils.cls.javassist.bytecode.DuplicateMemberException         when the field is already included.
     */
     ...
     * @see com.octopus.utils.cls.javassist.bytecode.MethodInfo
     */
     ...
     *
     * @throws com.octopus.utils.cls.javassist.bytecode.DuplicateMemberException         when the method is already included.
     */
