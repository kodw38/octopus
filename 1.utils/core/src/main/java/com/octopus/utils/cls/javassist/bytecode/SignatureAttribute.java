...
public class SignatureAttribute extends AttributeInfo {
    ...
    static private class Cursor {
        ...
        int indexOf(String s, int ch) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
     ...
     *
     * @see com.octopus.utils.cls.javassist.bytecode.SignatureAttribute.TypeArgument
     */
     ...
     * Type argument.
     *
     * @see com.octopus.utils.cls.javassist.bytecode.SignatureAttribute.TypeParameter
     */
    ...
    public static class BaseType extends Type {
        ...
        public BaseType(String typeName) {
            this(com.octopus.utils.cls.javassist.bytecode.Descriptor.of(typeName).charAt(0));
        }
        ...
        public CtClass getCtlass() {
            return com.octopus.utils.cls.javassist.bytecode.Descriptor.toPrimitiveClass(descriptor);
        }
         ...
         */
        public String toString() {
            return com.octopus.utils.cls.javassist.bytecode.Descriptor.toClassName(Character.toString(descriptor));
        }
     ...
     * @throws com.octopus.utils.cls.javassist.bytecode.BadBytecode          thrown when a syntactical error is found.
     * @see #getSignature()
     * @since 3.5
     */
    public static ClassSignature toClassSignature(String sig) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        try {
            return parseSig(sig);
        }
     ...
     * @since 3.5
     */
    public static MethodSignature toMethodSignature(String sig) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        try {
     ...
     * @since 3.5
     */
    public static ObjectType toFieldSignature(String sig) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        try {
     ...
     * @since 3.18
     */
    public static Type toTypeSignature(String sig) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
    	try {
    ...
    private static ClassSignature parseSig(String sig)
        throws com.octopus.utils.cls.javassist.bytecode.BadBytecode, IndexOutOfBoundsException
    {
    ...
    private static TypeArgument[] parseTypeArgs(String sig, Cursor c) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
    ...
    private static ObjectType parseArray(String sig, Cursor c) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
        int dim = 1;
    ...
    private static Type parseType(String sig, Cursor c) throws com.octopus.utils.cls.javassist.bytecode.BadBytecode {
    ...
    private static com.octopus.utils.cls.javassist.bytecode.BadBytecode error(String sig) {
