 ...
 */
public class EnclosingMethodAttribute extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     * The name of this attribute <code>"EnclosingMethod"</code>.
     */
    public static final String tag = "EnclosingMethod";

    EnclosingMethodAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }
     ...
     */
    public EnclosingMethodAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, String className,
    ...
    public int classIndex() {
        return com.octopus.utils.cls.javassist.bytecode.ByteArray.readU16bit(get(), 0);
    }
    ...
    public int methodIndex() {
        return com.octopus.utils.cls.javassist.bytecode.ByteArray.readU16bit(get(), 2);
    }
    ...
    public String methodName() {
        com.octopus.utils.cls.javassist.bytecode.ConstPool cp = getConstPool();
        int mi = methodIndex();
