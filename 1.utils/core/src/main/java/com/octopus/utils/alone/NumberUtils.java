...
public class NumberUtils {
    ...
    public static Object add(Object v1,Object v2)throws Exception{
        ...
        if(v1 instanceof String && v2 instanceof String){
            if(((String) v1).contains(".") || ((String) v2).contains("."))
                return String.valueOf(Double.parseDouble((String)v1)+Double.parseDouble((String)v2));
            else if(((String) v1).length()<=6 && ((String) v2).length()<=6) {
                return String.valueOf(Integer.parseInt((String) v1) + Integer.parseInt((String) v2));
            }else{
                return String.valueOf(Long.parseLong((String) v1) + Long.parseLong((String) v2));
            }
        }
        throw new Exception("now not support "+v1.getClass().getName()+" "+v2.getClass().getName()+" add");
    }
