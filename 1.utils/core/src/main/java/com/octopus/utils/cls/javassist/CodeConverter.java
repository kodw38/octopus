...
import com.octopus.utils.cls.javassist.convert.*;

/**
 * Simple translator of method bodies
 * (also see the <code>com.octopus.utils.cls.javassist.expr</code> package).
 *
 ...
 *
 * @see com.octopus.utils.cls.javassist.CtClass#instrument(com.octopus.utils.cls.javassist.CodeConverter)
 * @see com.octopus.utils.cls.javassist.CtMethod#instrument(com.octopus.utils.cls.javassist.CodeConverter)
 * @see com.octopus.utils.cls.javassist.expr.ExprEditor
 */
public class CodeConverter {
     ...
     */
    public void replaceNew(com.octopus.utils.cls.javassist.CtClass newClass,
                           com.octopus.utils.cls.javassist.CtClass calledClass, String calledMethod) {
     ...
     * replaced class. 
     */
    public void replaceNew(com.octopus.utils.cls.javassist.CtClass oldClass, com.octopus.utils.cls.javassist.CtClass newClass) {
     ...
     */
    public void redirectFieldAccess(com.octopus.utils.cls.javassist.CtField field,
                                    com.octopus.utils.cls.javassist.CtClass newClass, String newFieldname) {
     ...
     * @param calledMethod      the name of the static method.
     */
    public void replaceFieldRead(com.octopus.utils.cls.javassist.CtField field,
                                 com.octopus.utils.cls.javassist.CtClass calledClass, String calledMethod) {
     ...
     * @param calledMethod      the name of the static method.
     */
    public void replaceFieldWrite(com.octopus.utils.cls.javassist.CtField field,
                                  com.octopus.utils.cls.javassist.CtClass calledClass, String calledMethod) {
     ...
     * </pre>
     * 
     * @see com.octopus.utils.cls.javassist.CodeConverter.DefaultArrayAccessReplacementMethodNames
     * 
     ...
     */
    public void replaceArrayAccess(com.octopus.utils.cls.javassist.CtClass calledClass, ArrayAccessReplacementMethodNames names)
     ...
     */
    public void redirectMethodCall(com.octopus.utils.cls.javassist.CtMethod origMethod,
                                   com.octopus.utils.cls.javassist.CtMethod substMethod)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        ...
        if (!d1.equals(d2))
            throw new com.octopus.utils.cls.javassist.CannotCompileException("signature mismatch: "
                                             + substMethod.getLongName());

        int mod1 = origMethod.getModifiers();
        int mod2 = substMethod.getModifiers();
        if (com.octopus.utils.cls.javassist.Modifier.isStatic(mod1) != com.octopus.utils.cls.javassist.Modifier.isStatic(mod2)
            || (com.octopus.utils.cls.javassist.Modifier.isPrivate(mod1) && !Modifier.isPrivate(mod2))
            || origMethod.getDeclaringClass().isInterface()
               != substMethod.getDeclaringClass().isInterface())
            throw new com.octopus.utils.cls.javassist.CannotCompileException("invoke-type mismatch "
                                             + substMethod.getLongName());
     ...
     * @see com.octopus.utils.cls.javassist.CtMethod#setName(String)
     */
    public void redirectMethodCall(String oldMethodName,
                                   com.octopus.utils.cls.javassist.CtMethod newMethod)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        transformers
     ...
     */
    public void insertBeforeMethod(com.octopus.utils.cls.javassist.CtMethod origMethod,
                                   com.octopus.utils.cls.javassist.CtMethod beforeMethod)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        try {
     ...
     *                          <code>origMethod</code>.
     */
    public void insertAfterMethod(com.octopus.utils.cls.javassist.CtMethod origMethod,
