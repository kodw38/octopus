...
//    ftps        990/udp    ftp protocol, control, over TLS/SSL
    ...
    /** The FTPS {@link javax.net.ssl.TrustManager} implementation, default validate only: {@link org.apache.commons.net.util.TrustManagerUtils#getValidateServerCertificateTrustManager()}. */
    private TrustManager trustManager = TrustManagerUtils.getValidateServerCertificateTrustManager();

    /** The {@link javax.net.ssl.KeyManager}, default null (i.e. use system default). */
     ...
     * The default TrustManager is set from {@link org.apache.commons.net.util.TrustManagerUtils#getValidateServerCertificateTrustManager()}
     ...
     * Calls {@link #FTPSClient(boolean, javax.net.ssl.SSLContext)}
     * @param context A pre-configured SSL Context
     */
     ...
     * @throws java.io.IOException If it throw by _connectAction_.
     ...
     * @return The {@link javax.net.ssl.KeyManager} instance
     */
    ...
    */
     ...
     * When the underlying {@link java.net.Socket} instance is not SSL-enabled (i.e. an
     * instance of {@link javax.net.ssl.SSLSocket} with {@link javax.net.ssl.SSLSocket}{@link #getEnableSessionCreation()}) enabled,
     * this returns False.
     ...
     * When the underlying {@link java.net.Socket} is not an {@link javax.net.ssl.SSLSocket} instance, returns false.
     ...
     * When the underlying {@link java.net.Socket} is not an {@link javax.net.ssl.SSLSocket} instance, returns null.
     ...
     * @deprecated (3.3) Use {@link #_openDataConnection_(org.apache.commons.net.ftp.FTPCmd, String)} instead
     */
    @Override
    ...
    */
    ...
    /**
     * Override the default {@link javax.net.ssl.TrustManager} to use; if set to {@code null},
     ...
     * @exception java.io.IOException If an error occurs while disconnecting.
     * @since 3.0
     */
    @Override
     ...
     * The CCC (Clear Command Channel) command causes the underlying {@link javax.net.ssl.SSLSocket} instance  to be assigned
     * to a plain {@link java.net.Socket} instances
     * @return server reply.
     * @throws java.io.IOException If an I/O error occurs while sending
     * the command.
     * @since 3.0
