 ...
 *
 * @see com.octopus.utils.cls.javassist.CtClass#getDeclaredConstructors()
 * @see com.octopus.utils.cls.javassist.CtClass#getClassInitializer()
 * @see com.octopus.utils.cls.javassist.CtNewConstructor
 */
public final class CtConstructor extends CtBehavior {
    protected CtConstructor(MethodInfo minfo, com.octopus.utils.cls.javassist.CtClass declaring) {
     ...
     * @see com.octopus.utils.cls.javassist.CtConstructor#setBody(String)
     * @see com.octopus.utils.cls.javassist.CtConstructor#setBody(com.octopus.utils.cls.javassist.CtConstructor, com.octopus.utils.cls.javassist.ClassMap)
     */
    public CtConstructor(com.octopus.utils.cls.javassist.CtClass[] parameters, com.octopus.utils.cls.javassist.CtClass declaring) {
        ...
        setModifiers(com.octopus.utils.cls.javassist.Modifier.PUBLIC);
    }
     ...
     *
     * @see com.octopus.utils.cls.javassist.CtClass#addConstructor(com.octopus.utils.cls.javassist.CtConstructor)
     * @see com.octopus.utils.cls.javassist.ClassMap#fix(String)
     */
    public CtConstructor(CtConstructor src, com.octopus.utils.cls.javassist.CtClass declaring, ClassMap map)
     ...
     * such as <code>com.octopus.utils.cls.javassist.CtConstructor(CtClass[],CtClass)</code>.
     *
     * @since 3.5
     */
     ...
     */
    public boolean callsSuper() throws com.octopus.utils.cls.javassist.CannotCompileException {
     ...
     *                  <code>super()</code>.
     */
    public void setBody(String src) throws com.octopus.utils.cls.javassist.CannotCompileException {
        if (src == null)
     ...
     *                  It must be a single statement or block.
     */
    public void insertBeforeBody(String src) throws com.octopus.utils.cls.javassist.CannotCompileException {
        com.octopus.utils.cls.javassist.CtClass cc = declaringClass;
        cc.checkModify();
        if (isClassInitializer())
            throw new com.octopus.utils.cls.javassist.CannotCompileException("class initializer");
     ...
     */
    int getStartPosOfBody(CodeAttribute ca) throws com.octopus.utils.cls.javassist.CannotCompileException {
     ...
     */
    public com.octopus.utils.cls.javassist.CtMethod toMethod(String name, com.octopus.utils.cls.javassist.CtClass declaring)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
     ...
     */
    public com.octopus.utils.cls.javassist.CtMethod toMethod(String name, CtClass declaring, ClassMap map)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        com.octopus.utils.cls.javassist.CtMethod method = new CtMethod(null, declaring);
