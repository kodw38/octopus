 ...
 * @see com.octopus.utils.cls.javassist.bytecode.CodeAttribute
 */
public class Bytecode extends ByteVector implements Cloneable, Opcode {
     ...
     * 
     * @param cp            constant pool table.
     * @see com.octopus.utils.cls.javassist.bytecode.Bytecode#setMaxStack(int)
     * @see com.octopus.utils.cls.javassist.bytecode.Bytecode#setMaxLocals(int)
     */
     ...
     *
     * @see com.octopus.utils.cls.javassist.bytecode.Descriptor#of(com.octopus.utils.cls.javassist.CtClass)
     */
    public void addGetfield(CtClass c, String name, String type) {
        ...
        growStack(com.octopus.utils.cls.javassist.bytecode.Descriptor.dataSize(type) - 1);
    }
    ...
    public void addGetstatic(CtClass c, String name, String type) {
        ...
        int ci = constPool.addClassInfo(c);
        addIndex(constPool.addFieldrefInfo(ci, name, type));
        growStack(com.octopus.utils.cls.javassist.bytecode.Descriptor.dataSize(type));
    }
    ...
    public void addInvokespecial(CtClass clazz, String name,
        ...
        String desc = com.octopus.utils.cls.javassist.bytecode.Descriptor.ofMethod(returnType, paramTypes);
     ...
     *
     * @see com.octopus.utils.cls.javassist.bytecode.Descriptor#ofMethod(com.octopus.utils.cls.javassist.CtClass, com.octopus.utils.cls.javassist.CtClass[])
     * @see com.octopus.utils.cls.javassist.bytecode.Descriptor#ofConstructor(com.octopus.utils.cls.javassist.CtClass[])
     */
    ...
    public void addInvokespecial(int clazz, String name, String desc) {
        ...
        growStack(com.octopus.utils.cls.javassist.bytecode.Descriptor.dataSize(desc) - 1);
    }
    ...
    public void addInvokestatic(int clazz, String name, String desc) {
        add(INVOKESTATIC);
        addIndex(constPool.addMethodrefInfo(clazz, name, desc));
        growStack(com.octopus.utils.cls.javassist.bytecode.Descriptor.dataSize(desc));
    }
    ...
    public void addInvokedynamic(int bootstrap, String name, String desc) {
        ...
        addIndex(dyn);
        add(0, 0);
        growStack(com.octopus.utils.cls.javassist.bytecode.Descriptor.dataSize(desc));   // assume ConstPool#REF_invokeStatic
    }
     ...
     * @see com.octopus.utils.cls.javassist.bytecode.Opcode
     */
    ...
    private void addPutfield0(CtClass target, String classname,
        ...
        growStack(-1 - com.octopus.utils.cls.javassist.bytecode.Descriptor.dataSize(desc));
    }
