...
public class Javac {
     ...
     */
    public CtMember compile(String src) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        try {
            ...
            throw new com.octopus.utils.cls.javassist.compiler.CompileError(bb.getMessage());
        }
        catch (CannotCompileException e) {
            throw new com.octopus.utils.cls.javassist.compiler.CompileError(e.getMessage());
        }
    }
    ...
    private CtField compileField(FieldDecl fd)
        throws com.octopus.utils.cls.javassist.compiler.CompileError, CannotCompileException
    {
        CtFieldWithInit f;
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        try {
            ...
            throw new com.octopus.utils.cls.javassist.compiler.CompileError(e.toString());
        }
    }
     ...
     * @see #recordType(com.octopus.utils.cls.javassist.CtClass)
     */
     ...
     */
    public void compileStmnt(String src) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        Parser p = new Parser(new Lex(src));
        SymbolTable stb = new SymbolTable(stable);
        while (p.hasMore()) {
            Stmnt s = p.parseStatement(stb);
     ...
     * have been invoked.
     */
    public void compileExpr(String src) throws com.octopus.utils.cls.javassist.compiler.CompileError {
