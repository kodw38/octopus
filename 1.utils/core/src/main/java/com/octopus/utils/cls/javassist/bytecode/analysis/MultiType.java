 ...
 * {@link com.octopus.utils.cls.javassist.bytecode.analysis.Type#isAssignableFrom(com.octopus.utils.cls.javassist.bytecode.analysis.Type)}, as well as removing non-intersecting
 ...
 */
public class MultiType extends com.octopus.utils.cls.javassist.bytecode.analysis.Type {
    private Map interfaces;
    private com.octopus.utils.cls.javassist.bytecode.analysis.Type resolved;
    private com.octopus.utils.cls.javassist.bytecode.analysis.Type potentialClass;
    ...
    public MultiType(Map interfaces, com.octopus.utils.cls.javassist.bytecode.analysis.Type potentialClass) {
        super(null);
    ...
    public CtClass getCtClass() {
        ...
        return com.octopus.utils.cls.javassist.bytecode.analysis.Type.OBJECT.getCtClass();
    }
    ...
    public boolean isAssignableTo(com.octopus.utils.cls.javassist.bytecode.analysis.Type type) {
        ...
        if (com.octopus.utils.cls.javassist.bytecode.analysis.Type.OBJECT.equals(type))
            return true;
        ...
        if (map.size() == 1 && potentialClass == null) {
            ...
            resolved = com.octopus.utils.cls.javassist.bytecode.analysis.Type.get((CtClass) map.values().iterator().next());
            propogateResolved();
    ...
    private Map mergeMultiAndSingle(MultiType multi, com.octopus.utils.cls.javassist.bytecode.analysis.Type single) {
    ...
    public com.octopus.utils.cls.javassist.bytecode.analysis.Type merge(com.octopus.utils.cls.javassist.bytecode.analysis.Type type) {
        if (this == type)
            return this;
        ...
        if (potentialClass != null) {
            com.octopus.utils.cls.javassist.bytecode.analysis.Type mergePotential = potentialClass.merge(type);
            if (! mergePotential.equals(potentialClass) || mergePotential.popChanged()) {
                potentialClass = com.octopus.utils.cls.javassist.bytecode.analysis.Type.OBJECT.equals(mergePotential) ? null : mergePotential;
                changed = true;
            }
        }
        ...
        if (merged.size() == 1) {
            resolved = com.octopus.utils.cls.javassist.bytecode.analysis.Type.get((CtClass) merged.values().iterator().next());
