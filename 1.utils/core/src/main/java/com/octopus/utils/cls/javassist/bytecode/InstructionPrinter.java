 ...
 */
public class InstructionPrinter implements com.octopus.utils.cls.javassist.bytecode.Opcode {
    ...
    public void print(CtMethod method) {
        ...
        com.octopus.utils.cls.javassist.bytecode.ConstPool pool = info.getConstPool();
        CodeAttribute code = info.getCodeAttribute();
        if (code == null)
            return;

        com.octopus.utils.cls.javassist.bytecode.CodeIterator iterator = code.iterator();
     ...
     * position. 
     */
    public static String instructionString(com.octopus.utils.cls.javassist.bytecode.CodeIterator iter, int pos, com.octopus.utils.cls.javassist.bytecode.ConstPool pool) {
    ...
    private static String wide(com.octopus.utils.cls.javassist.bytecode.CodeIterator iter, int pos) {
    ...
    private static String classInfo(com.octopus.utils.cls.javassist.bytecode.ConstPool pool, int index) {
        return "#" + index + " = Class " + pool.getClassInfo(index);
    }


    private static String interfaceMethodInfo(com.octopus.utils.cls.javassist.bytecode.ConstPool pool, int index) {
        return "#" + index + " = Method "
    ...
    private static String methodInfo(com.octopus.utils.cls.javassist.bytecode.ConstPool pool, int index) {
        return "#" + index + " = Method "
    ...
    private static String fieldInfo(com.octopus.utils.cls.javassist.bytecode.ConstPool pool, int index) {
        return "#" + index + " = Field "
    ...
    private static String lookupSwitch(com.octopus.utils.cls.javassist.bytecode.CodeIterator iter, int pos) {
    ...
    private static String ldc(com.octopus.utils.cls.javassist.bytecode.ConstPool pool, int index) {
        int tag = pool.getTag(index);
        switch (tag) {
            case com.octopus.utils.cls.javassist.bytecode.ConstPool.CONST_String:
                return "#" + index + " = \"" + pool.getStringInfo(index) + "\"";
            case com.octopus.utils.cls.javassist.bytecode.ConstPool.CONST_Integer:
                return "#" + index + " = int " + pool.getIntegerInfo(index);
            case com.octopus.utils.cls.javassist.bytecode.ConstPool.CONST_Float:
                return "#" + index + " = float " + pool.getFloatInfo(index);
            case com.octopus.utils.cls.javassist.bytecode.ConstPool.CONST_Long:
                return "#" + index + " = long " + pool.getLongInfo(index);
            case com.octopus.utils.cls.javassist.bytecode.ConstPool.CONST_Double:
