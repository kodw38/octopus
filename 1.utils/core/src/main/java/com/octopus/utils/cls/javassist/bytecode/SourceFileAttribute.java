...
public class SourceFileAttribute extends AttributeInfo {
    ...
    SourceFileAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }
     ...
     */
    public SourceFileAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, String filename) {
        super(cp, tag);
