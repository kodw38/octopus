package com.octopus.utils.net.mail;
...
public class POP3SClient extends POP3Client
{
    ...
    private void performSSLNegotiation() throws IOException {
        ...
        try {
            ClassUtils.setFieldValue(this,"_reader",new CRLFLineReader(new InputStreamReader(_input_, (String)ClassUtils.getFieldValue(this,"_DEFAULT_ENCODING",true))),true);
            ClassUtils.setFieldValue(this,"_writer",new BufferedWriter(new OutputStreamWriter(_output_, (String)ClassUtils.getFieldValue(this,"_DEFAULT_ENCODING",true))),true);
