 ...
 * Variable.
 */
public class Variable extends com.octopus.utils.cls.javassist.compiler.ast.Symbol {
    protected com.octopus.utils.cls.javassist.compiler.ast.Declarator declarator;

    public Variable(String sym, com.octopus.utils.cls.javassist.compiler.ast.Declarator d) {
        super(sym);
        declarator = d;
    }
