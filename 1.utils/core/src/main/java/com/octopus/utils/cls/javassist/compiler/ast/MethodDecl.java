...
public class MethodDecl extends ASTList {
    ...
    public MethodDecl(com.octopus.utils.cls.javassist.compiler.ast.ASTree _head, ASTList _tail) {
        super(_head, _tail);
    }
    ...
    public com.octopus.utils.cls.javassist.compiler.ast.Declarator getReturn() { return (Declarator)tail().head(); }
