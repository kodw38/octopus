...
import com.octopus.utils.cls.javassist.bytecode.AccessFlag;
 ...
 */
public class MemberResolver implements com.octopus.utils.cls.javassist.compiler.TokenId {
    ...
    private static void fatal() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("no such field: " + fieldName.get());
    }

    public CtClass lookupClassByName(ASTList name) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        return lookupClass(Declarator.astToClassName(name, '.'), false);
    }

    public CtClass lookupClassByJvmName(String jvmName) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        return lookupClass(jvmToJavaName(jvmName), false);
    }

    public CtClass lookupClass(Declarator decl) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     */
    static String getTypeName(int type) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        String cname = "";
        switch (type) {
        case BOOLEAN :
            cname = "boolean";
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        if (found == INVALID)
            throw new com.octopus.utils.cls.javassist.compiler.CompileError("no such class: " + name);
        else if (found != null)
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("no such class: " + orgName);
    }
     ...
     */
    public String resolveClassName(ASTList name) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (name == null)
            return null;
        else
     ...
     * For example, this converts Object into java/lang/Object.
     */
    public String resolveJvmClassName(String jvmName) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (jvmName == null)
            return null;
        else
    ...
    public static CtClass getSuperclass(CtClass c) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        try {
        ...
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("cannot find the super class of "
                               + c.getName());
    }
