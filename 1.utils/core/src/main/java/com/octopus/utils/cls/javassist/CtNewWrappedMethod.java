...
import com.octopus.utils.cls.javassist.compiler.JvstCodeGen;
...
class CtNewWrappedMethod {
    ...
    public static com.octopus.utils.cls.javassist.CtMethod wrapped(com.octopus.utils.cls.javassist.CtClass returnType, String mname,
                                   com.octopus.utils.cls.javassist.CtClass[] parameterTypes,
                                   com.octopus.utils.cls.javassist.CtClass[] exceptionTypes,
                                   com.octopus.utils.cls.javassist.CtMethod body, ConstParameter constParam,
                                   com.octopus.utils.cls.javassist.CtClass declaring)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
        com.octopus.utils.cls.javassist.CtMethod mt = new com.octopus.utils.cls.javassist.CtMethod(returnType, mname, parameterTypes,
                                   declaring);
    ...
    static Bytecode makeBody(com.octopus.utils.cls.javassist.CtClass clazz, ClassFile classfile,
                             com.octopus.utils.cls.javassist.CtMethod wrappedBody,
                             com.octopus.utils.cls.javassist.CtClass[] parameters,
                             com.octopus.utils.cls.javassist.CtClass returnType,
     ...
     */
    protected static int makeBody0(com.octopus.utils.cls.javassist.CtClass clazz, ClassFile classfile,
                                   com.octopus.utils.cls.javassist.CtMethod wrappedBody,
                                   boolean isStatic, com.octopus.utils.cls.javassist.CtClass[] parameters,
                                   com.octopus.utils.cls.javassist.CtClass returnType, ConstParameter cparam,
                                   Bytecode code)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
    ...
    private static void checkSignature(com.octopus.utils.cls.javassist.CtMethod wrappedBody,
                                       String descriptor)
        throws com.octopus.utils.cls.javassist.CannotCompileException
    {
    ...
    private static String addBodyMethod(CtClassType clazz,
                                        ClassFile classfile,
                                        com.octopus.utils.cls.javassist.CtMethod src)
        throws BadBytecode, CannotCompileException
    {
        ...
        if (bodyname == null) {
            ...
            com.octopus.utils.cls.javassist.ClassMap map = new ClassMap();
    ...
    static int compileParameterList(Bytecode code,
                                    com.octopus.utils.cls.javassist.CtClass[] params, int regno) {
     ...
     */
    private static void compileReturn(Bytecode code, com.octopus.utils.cls.javassist.CtClass type) {
        if (type.isPrimitive()) {
            com.octopus.utils.cls.javassist.CtPrimitiveType pt = (CtPrimitiveType)type;
