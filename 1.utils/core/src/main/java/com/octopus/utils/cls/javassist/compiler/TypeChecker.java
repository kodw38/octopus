...
import com.octopus.utils.cls.javassist.bytecode.FieldInfo;
import com.octopus.utils.cls.javassist.bytecode.MethodInfo;
import com.octopus.utils.cls.javassist.bytecode.Opcode;
import com.octopus.utils.cls.javassist.compiler.ast.*;

public class TypeChecker extends Visitor implements Opcode, com.octopus.utils.cls.javassist.compiler.TokenId {
    ...
    protected com.octopus.utils.cls.javassist.compiler.MemberResolver resolver;
    protected CtClass   thisClass;
    protected MethodInfo thisMethod;

    public TypeChecker(CtClass cc, ClassPool cp) {
        resolver = new com.octopus.utils.cls.javassist.compiler.MemberResolver(cp);
        thisClass = cc;
        thisMethod = null;
    }
    ...
    protected static StringBuffer typeToString(StringBuffer sbuf,
        ...
        String s;
        if (type == CLASS)
            s = com.octopus.utils.cls.javassist.compiler.MemberResolver.jvmToJavaName(cname);
        else if (type == NULL)
            s = "Object";
        else
            try {
                s = com.octopus.utils.cls.javassist.compiler.MemberResolver.getTypeName(type);
            }
            catch (com.octopus.utils.cls.javassist.compiler.CompileError e) {
                s = "?";
            }
    ...
    protected String getThisName() {
        return com.octopus.utils.cls.javassist.compiler.MemberResolver.javaToJvmName(thisClass.getName());
    }

    /**
     * Returns the JVM-internal representation of this super class name.
     */
    protected String getSuperName() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        return com.octopus.utils.cls.javassist.compiler.MemberResolver.javaToJvmName(
                com.octopus.utils.cls.javassist.compiler.MemberResolver.getSuperclass(thisClass).getName());
    }
     ...
     */
    protected String resolveClassName(ASTList name) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     * For example, this converts Object into java/lang/Object.
     */
    protected String resolveClassName(String jvmName) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        return resolver.resolveJvmClassName(jvmName);
    }

    public void atNewExpr(NewExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (expr.isArray())
            atNewArrayExpr(expr);
        else {
            ...
            exprType = CLASS;
            arrayDim = 0;
            className = com.octopus.utils.cls.javassist.compiler.MemberResolver.javaToJvmName(cname);
        }
    }

    public void atNewArrayExpr(NewExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    public void atArrayInit(ArrayInit init) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ASTList list = init;
        while (list != null) {
            ASTree h = list.head();
            list = list.tail();
    ...
    private void atArrayAssign(Expr expr, int op, Expr array,
                        ASTree right) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    public void atCondExpr(CondExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        if (dim1 == 0 && dim1 == arrayDim)
            if (com.octopus.utils.cls.javassist.compiler.CodeGen.rightIsStrong(type1, exprType))
                expr.setThen(new CastExpr(exprType, 0, expr.thenExpr()));
            else if (com.octopus.utils.cls.javassist.compiler.CodeGen.rightIsStrong(exprType, type1)) {
    ...
    public void atBinExpr(BinExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ...
        int k = com.octopus.utils.cls.javassist.compiler.CodeGen.lookupBinOp(token);
        if (k >= 0) {
     ...
     */
    private Expr atPlusExpr(BinExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        ASTree left = expr.oprand1();
        ASTree right = expr.oprand2();
        if (right == null) {
    ...
    public static ASTree getConstantFieldValue(CtField f) {
        ...
        if (value instanceof String)
            ...
            return new Keyword(((Boolean)value).booleanValue()
                               ? com.octopus.utils.cls.javassist.compiler.TokenId.TRUE : com.octopus.utils.cls.javassist.compiler.TokenId.FALSE);
        else
            return null;
    }
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        if (com.octopus.utils.cls.javassist.compiler.CodeGen.isP_INT(exprType))
    ...
    private void booleanExpr(ASTree expr)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        int op = com.octopus.utils.cls.javassist.compiler.CodeGen.getCompOperator(expr);
        if (op == EQ) {         // ==, !=, ...
            BinExpr bexpr = (BinExpr)expr;
    ...
    private void insertCast(BinExpr expr, int type1, int type2)
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        if (com.octopus.utils.cls.javassist.compiler.CodeGen.rightIsStrong(type1, type2))
    ...
    public void atCallExpr(CallExpr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        String mname = null;
        ...
        if (method instanceof Member) {
            ...
            if (((Keyword)method).get() == SUPER)
                targetClass = com.octopus.utils.cls.javassist.compiler.MemberResolver.getSuperclass(thisClass);
            else
                targetClass = thisClass;
        }
            ...
            if (op == MEMBER)                // static method
                ...
                try {
                    ...
                    e.setOprand1(new Symbol(com.octopus.utils.cls.javassist.compiler.MemberResolver.jvmToJavaName(
                            className)));
                }
        ...
        com.octopus.utils.cls.javassist.compiler.MemberResolver.Method minfo
                = atMethodCallCore(targetClass, mname, args);
        expr.setMethod(minfo);
    }

    private static void badMethod() throws com.octopus.utils.cls.javassist.compiler.CompileError {
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad method");
    }
     ...
     */
    public com.octopus.utils.cls.javassist.compiler.MemberResolver.Method atMethodCallCore(CtClass targetClass,
        ...
        throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
        ...
        com.octopus.utils.cls.javassist.compiler.MemberResolver.Method found
    ...
    public void atMethodArgs(ASTList args, int[] types, int[] dims,
                             String[] cnames) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int i = 0;
        while (args != null) {
            ASTree a = args.head();
            a.accept(this);
    ...
    void setReturnType(String desc) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        int i = desc.indexOf(')');
        if (i < 0)
            badMethod();
        ...
        if (c == 'L') {
            ...
            exprType = com.octopus.utils.cls.javassist.compiler.MemberResolver.descToType(c);
            className = null;
        }
    }

    private void atFieldRead(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        atFieldRead(fieldAccess(expr));
    }

    private void atFieldRead(CtField f) throws com.octopus.utils.cls.javassist.compiler.CompileError {
     ...
     */
    protected CtField fieldAccess(ASTree expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        if (expr instanceof Member) {
            ...
            if (op == MEMBER) {
                ...
                com.octopus.utils.cls.javassist.compiler.CompileError err = null;
                try {
                    if (exprType == CLASS && arrayDim == 0)
                        return resolver.lookupFieldByJvmName(className,
                                                    (Symbol)e.oprand2());
                }
                catch (com.octopus.utils.cls.javassist.compiler.CompileError ce) {
                    err = ce;
                }
                 ...
                 *
                 * String m() { return com.octopus.utils.cls.javassist.CtClass.intType.toString(); }
                 *
        ...
        throw new com.octopus.utils.cls.javassist.compiler.CompileError("bad filed access");
    }

    private CtField fieldAccess2(Expr e, String jvmClassName) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    public void atArrayLength(Expr expr) throws com.octopus.utils.cls.javassist.compiler.CompileError {
    ...
    protected void atFieldPlusPlus(ASTree oprand) throws com.octopus.utils.cls.javassist.compiler.CompileError
    {
    ...
    public void atMember(Member mem) throws com.octopus.utils.cls.javassist.compiler.CompileError {
        atFieldRead(mem);
    }
