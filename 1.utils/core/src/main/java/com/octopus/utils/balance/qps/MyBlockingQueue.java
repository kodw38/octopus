 ...
 */
public class MyBlockingQueue<E> extends AbstractQueue<E>
    ...
    private class Itr implements Iterator<E> {
        ...
        Itr() {
            ...
            lastRet = NONE;
            final ReentrantLock lock = MyBlockingQueue.this.lock;
            lock.lock();
            try {
                if (count == 0) {
                    // assert itrs == null;
                    ...
                    final int takeIndex = MyBlockingQueue.this.takeIndex;
