 ...
 */
public class ExceptionsAttribute extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     * The name of this attribute <code>"Exceptions"</code>.
     */
    public static final String tag = "Exceptions";

    ExceptionsAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }
     ...
     */
    private ExceptionsAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, ExceptionsAttribute src,
                                Map classnames) {
        super(cp, tag);
     ...
     * @param cp                constant pool table.
     */
    public ExceptionsAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp) {
        super(cp, tag);
    ...
    private void copyFrom(ExceptionsAttribute srcAttr, Map classnames) {
        com.octopus.utils.cls.javassist.bytecode.ConstPool srcCp = srcAttr.constPool;
