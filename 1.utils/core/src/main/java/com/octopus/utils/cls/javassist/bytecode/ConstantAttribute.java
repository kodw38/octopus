 ...
 */
public class ConstantAttribute extends com.octopus.utils.cls.javassist.bytecode.AttributeInfo {
    /**
     * The name of this attribute <code>"ConstantValue"</code>.
     */
    public static final String tag = "ConstantValue";

    ConstantAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int n, DataInputStream in)
        throws IOException
    {
        super(cp, n, in);
    }
     ...
     */
    public ConstantAttribute(com.octopus.utils.cls.javassist.bytecode.ConstPool cp, int index) {
        super(cp, tag);
