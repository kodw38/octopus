...
public final class RC2 {
  ...
  public String decrypt(String s) throws Exception {      
      return decrypt_rc2_array_base64(s.getBytes(), key);
  }
  ...
  public String encrypt(String s) throws Exception {      
      return encrypt_rc2_array_base64(s.getBytes(), key);
  }
	  ...
	  try{
		  ...
		  if(args.length==2){
			  if("d".equalsIgnoreCase(args[0])){
				  System.out.println(r.decrypt(args[1]));
			  }
			  if("e".equalsIgnoreCase(args[0])){
				  System.out.println(r.encrypt(args[1]));
			  }
		  }
