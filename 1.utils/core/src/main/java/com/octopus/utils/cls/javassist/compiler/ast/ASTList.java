 ...
 */
public class ASTList extends com.octopus.utils.cls.javassist.compiler.ast.ASTree {
    private com.octopus.utils.cls.javassist.compiler.ast.ASTree left;
    private ASTList right;

    public ASTList(com.octopus.utils.cls.javassist.compiler.ast.ASTree _head, ASTList _tail) {
        left = _head;
        right = _tail;
    }

    public ASTList(com.octopus.utils.cls.javassist.compiler.ast.ASTree _head) {
        left = _head;
        right = null;
    }

    public static ASTList make(com.octopus.utils.cls.javassist.compiler.ast.ASTree e1, com.octopus.utils.cls.javassist.compiler.ast.ASTree e2, com.octopus.utils.cls.javassist.compiler.ast.ASTree e3) {
    ...
    public void setRight(com.octopus.utils.cls.javassist.compiler.ast.ASTree _right) {
     ...
     */
    public com.octopus.utils.cls.javassist.compiler.ast.ASTree head() { return left; }

    public void setHead(com.octopus.utils.cls.javassist.compiler.ast.ASTree _head) {
        left = _head;
    }
    ...
    public String toString() {
        ...
        while (list != null) {
            sbuf.append(' ');
            com.octopus.utils.cls.javassist.compiler.ast.ASTree a = list.left;
     ...
     * list.
     */
    public boolean subst(com.octopus.utils.cls.javassist.compiler.ast.ASTree newObj, com.octopus.utils.cls.javassist.compiler.ast.ASTree oldObj) {
     ...
     */
    public static ASTList append(ASTList a, com.octopus.utils.cls.javassist.compiler.ast.ASTree b) {
