...
public class LocalVariableAttribute extends AttributeInfo {
    ...
    String renameEntry(String desc, String oldname, String newname) {
        return com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(desc, oldname, newname);
    }
    ...
    String renameEntry(String desc, Map classnames) {
        return com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(desc, classnames);
    }
    ...
    public AttributeInfo copy(ConstPool newCp, Map classnames) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (type != 0)  {
                ...
                sig = com.octopus.utils.cls.javassist.bytecode.Descriptor.rename(sig, classnames);
