...
public abstract class Expr implements Opcode {
     ...
     * @since 3.1
     */
    public void replace(String statement, com.octopus.utils.cls.javassist.expr.ExprEditor recursive)
        throws CannotCompileException
    {
        replace(statement);
        if (recursive != null)
    ...
    protected void runEditor(com.octopus.utils.cls.javassist.expr.ExprEditor ed, CodeIterator oldIterator)
        throws CannotCompileException
    {
        ...
        com.octopus.utils.cls.javassist.expr.ExprEditor.LoopContext context
            = new com.octopus.utils.cls.javassist.expr.ExprEditor.LoopContext(newLocals);
