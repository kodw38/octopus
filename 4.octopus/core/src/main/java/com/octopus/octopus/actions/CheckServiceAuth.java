...
import com.octopus.isp.actions.CheckAuth;
 ...
 * Time: 下午5:13
 */
public class CheckServiceAuth extends CheckAuth {
    public CheckServiceAuth(XMLMakeup xml, XMLObject parent,Object[] containers) throws Exception {
