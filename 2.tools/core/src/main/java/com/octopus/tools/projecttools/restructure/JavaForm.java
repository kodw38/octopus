...
public class JavaForm {
    ...
    public static void main(String[] args) {
        ...
        try {
            StringBuffer sb = FileUtils.getFileContentStringBuffer("C:\\work\\flyingserver_aigit\\flyingserver-app-repository\\nucleus\\core\\bootstrap\\src\\main\\java\\com\\sun\\enterprise\\glassfish\\bootstrap\\MainHelper.java");

            str = formJava(sb.toString());
    ...
    public static Map<String,String> mapZY = new ConcurrentHashMap();
    /**
